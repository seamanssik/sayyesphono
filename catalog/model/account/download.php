...
class ModelAccountDownload extends Model {
	...
	public function getHistories($customer_id) {
		$query = $this->db->query("SELECT customer_history_id, title, comment, date_added FROM " . DB_PREFIX . "customer_history WHERE customer_id = '" . (int)$customer_id . "' ORDER BY date_added DESC");
