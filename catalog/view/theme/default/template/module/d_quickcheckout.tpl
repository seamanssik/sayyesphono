...
<div id="d_quickcheckout">
	...
	<div class="row">
		<div class="qc-col-1 col-md-<?php echo $config['design']['column_width'][1] ?> col-sm-12">
		</div>
		<div class="col-md-<?php echo $config['design']['column_width'][4] ?> col-sm-12">
			<div class="checkout-title"><span>2.</span> Оформление заказа</div>
			<div class="row">
