<div class="best hidden-sm hidden-xs">
    <div class="container">
        <div class="best-title js-animate" data-top="transform: translate3d(0,10%,0)" data-600-top="transform: translate3d(0,-25%,0)"><div class="c-text-masked"><span>—Лучшая модель</span></div></div>
    </div>
