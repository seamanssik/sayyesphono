...
<div class="visible-xs" id="ocfilter-mobile">
  <nav class="navbar navbar-default">
    <div class="navbar-header ocfilter-navbar">
      <button data-target="#navbar-ocfilter" data-toggle="collapse" class="btn btn-navbar navbar-toggle" type="button">Показать фильтр</button>
    </div>
...
<div class="panel ocfilter panel-default" id="ocfilter">
  ...
  <div <?php /* ?>class="list-group" <?php */ ?>id="ocfilter-content">
      <?php if ($selecteds) { # Selected options ?>
      <div class="<?php /* ?>list-group-item <?php */ ?>selected-options">
      ...
      <div class="<?php /* ?>list-group-item <?php */ ?>ocfilter-option" data-toggle="popover-price">
      ...
      <?php } ?>
			<?php } ?>
				...
				<div class="<?php /* ?>list-group-item <?php */ ?> ocfilter-option" id="option-<?php echo $option['option_id']; ?>">
	        <div class="option-name">
