<div class="container">
	<div class="article">
		<div class="row">
			<div class="col-ed-8 col-ed-offset-2 col-lg-10 col-lg-offset-1">
				<div class="article-thumb">
					<div class="article-date js-animate">
						<div class="article-date__item">
							<span class="date"><?php echo $date; ?></span>
							<span class="year"><?php echo $year; ?></span>
						</div>
					</div>
					<div class="article-thumb__overlay js-animate">
						<div class="article-thumb__img">
							<img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" />
						</div>
					</div>
					<div class="article-category js-animate">
						<div class="article-category__item"><?php echo $category; ?></div>
					</div>
				</div>
				<div class="article-description js-animate">
...
<div class="article-carousel">
	<div id="articleCarousel" class="owl-carousel">
		<?php foreach ($gallery_images as $gallery) { ?>
			<div class="item text-center">
				<a href="<?php echo $gallery['popup']; ?>" title="<?php echo $gallery['text']; ?>"><img src="<?php echo $gallery['thumb']; ?>" alt="<?php echo $gallery['text']; ?>" class="img-responsive" /></a>
			</div>
		<?php } ?>
	</div>
</div>
...
<div class="container">
	<div class="article">
		<div class="row">
			<div class="col-ed-8 col-ed-offset-2 col-lg-10 col-lg-offset-1">
				<?php if (mb_strlen($custom1) > 15) { ?><div class="article-description js-animate">
					<?php echo $custom1; ?>
				</div>
				<?php } ?>
				<div class="article-share">
					<span class="article-share__title">Расскажи подругам!</span>
					<div class="share42init" id="share42init" data-image="<?php echo $share; ?>" data-title="<?php echo $heading_title; ?>" data-description="<?php echo utf8_substr(strip_tags($description), 0, 160); ?>..."></div>
				</div>
			</div>
		</div>
	</div>
	<div class="article-cd-pagination">
		<ul class="article-pagination">
			<?php if ($pagination_prev) { ?><li class="article-pagination__item"><a href="<?php echo $pagination_prev; ?>" class="article-pagination__link">← Предыдущая статья</a></li><?php } ?>
			<li class="article-pagination__item"><a href="<?php echo $category_link; ?>" class="article-pagination__link">Вернуться к списку статей</a></li>
			<?php if ($pagination_next) { ?><li class="article-pagination__item"><a href="<?php echo $pagination_next; ?>" class="article-pagination__link">Следующая статья →</a></li><?php } ?>
		</ul>
	</div>
</div>
<?php /* ?>
