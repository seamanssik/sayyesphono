<div class="container">
	<div class="cd-container heading-left">
		<div class="row">
			<div class="cd-content">
				<div class="articles">
					<?php foreach ($article as $articles) { ?>
						<div class="articleItem">
							<div class="articleItem-col">
								<div class="articleItem-figure__border">
								</div>
								<div class="articleItem-figure js-animate">
									<div class="articleItem-date"><?php echo $articles['date_added']; ?></div>
									<div class="articleItem-figure__img">
										<a href="<?php echo $articles['href']; ?>"><img src="<?php echo $articles['thumb']; ?>" alt="<?php echo $articles['name']; ?>" /></a>
									</div>
								</div>
							</div>
							<div class="articleItem-col info">
								<div class="articleItem-info">
									<div class="articleItem-year"><?php echo $articles['date_year']; ?></div>
									<div class="articleItem-category"><?php echo $articles['category']; ?></div>
								</div>
								<div class="articleItem-description">
									<div class="title"><?php echo $articles['name']; ?></div>
									<div class="description"><?php echo $articles['description']; ?></div>
								</div>
								<div class="text-right">
									<a href="<?php echo $articles['href']; ?>" class="articleItem-link"><span>Подробнее</span></a>
								</div>
							</div>
						</div>
					<?php } ?>
			...
			<div class="cd-column">
				<div class="cd-column__title js-animate"><div class="c-text-masked"><span>Разделы блога:</span></div></div>
				<ul class="cd-column__list">
					<?php foreach ($categories as $category) { ?>
						<li class="cd-column__list-item"><a href="<?php echo $category['href']; ?>" class="cd-column__list-link"><?php echo $category['name']; ?></a></li>
					<?php } ?>
				</ul>
			</div>
		</div>
