...
<!--            <div class="h3"><span>Изменить персональные данные</span></div>-->
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="account-form form-horizontal">
                ...
                <div class="form-group account-form__group required">
                    <div class="col-sm-12">
                        <label class="control-label account-form__label" for="input-address-1"><?php echo $entry_address_1; ?></label>
                        <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="form-control account-form__control" />
                ...
                <div class="form-group account-form__group required">
                    <div class="col-sm-12">
                        <label class="control-label account-form__label" for="input-city"><?php echo $entry_city; ?></label>
                        <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city" class="form-control account-form__control" />
                        <?php if ($error_city) { ?>
                ...
                <div class="form-group account-form__group required">
                    <div class="col-sm-12">
                        <label class="control-label account-form__label" for="input-country"><?php echo $entry_country; ?></label>
                        <select name="country_id" id="input-country" class="form-control account-form__control">
                ...
                <div class="form-group account-form__group required">
                    <div class="col-sm-12">
                        <label class="control-label account-form__label" for="input-zone"><?php echo $entry_zone; ?></label>
                        <select name="zone_id" id="input-zone" class="form-control account-form__control">
                        </select>
                        <?php if ($error_zone) { ?>
                        ...
                        <?php if ($custom_field['location'] == 'address') { ?>
                            ...
                            <?php if ($custom_field['type'] == 'textarea') { ?>
                                <div class="form-group account-form__group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                                    <label class="col-sm-2 control-label account-form__label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
                                    <div class="col-sm-10">
                                        <textarea name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control account-form__control"><?php echo (isset($address_custom_field[$custom_field['custom_field_id']]) ? $address_custom_field[$custom_field['custom_field_id']] : $custom_field['value']); ?></textarea>
                                        <?php if (isset($error_custom_field[$custom_field['custom_field_id']])) { ?>
                                            <div class="text-danger"><?php echo $error_custom_field[$custom_field['custom_field_id']]; ?></div>
                                        <?php } ?>
                                    </div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group account-form__group">
            <label class="col-sm-2 control-label account-form__label" for="input-company"><?php echo $entry_company; ?></label>
            <div class="col-sm-10">
              <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control account-form__control" />
            </div>
          </div>
          <div class="form-group account-form__group required">
            <label class="col-sm-2 control-label account-form__label" for="input-address-1"><?php echo $entry_address_1; ?></label>
            <div class="col-sm-10">
              <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="form-control account-form__control" />
              <?php if ($error_address_1) { ?>
              <div class="text-danger"><?php echo $error_address_1; ?></div>
          ...
          <div class="form-group account-form__group">
            <label class="col-sm-2 control-label account-form__label" for="input-address-2"><?php echo $entry_address_2; ?></label>
            <div class="col-sm-10">
              <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control account-form__control" />
            </div>
          </div>
          <div class="form-group account-form__group required">
            <label class="col-sm-2 control-label account-form__label" for="input-city"><?php echo $entry_city; ?></label>
            <div class="col-sm-10">
              <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city" class="form-control account-form__control" />
              <?php if ($error_city) { ?>
              <div class="text-danger"><?php echo $error_city; ?></div>
          ...
          <div class="form-group account-form__group required">
            <label class="col-sm-2 control-label account-form__label" for="input-postcode"><?php echo $entry_postcode; ?></label>
            <div class="col-sm-10">
              <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control account-form__control" />
          ...
          <div class="form-group account-form__group required">
            <label class="col-sm-2 control-label account-form__label" for="input-country"><?php echo $entry_country; ?></label>
            <div class="col-sm-10">
              <select name="country_id" id="input-country" class="form-control account-form__control">
                <option value=""><?php echo $text_select; ?></option>
                <?php foreach ($countries as $country) { ?>
          ...
          <div class="form-group account-form__group required">
            <label class="col-sm-2 control-label account-form__label" for="input-zone"><?php echo $entry_zone; ?></label>
            <div class="col-sm-10">
              <select name="zone_id" id="input-zone" class="form-control account-form__control">
              </select>
              <?php if ($error_zone) { ?>
          ...
          <?php } ?>
          <div class="form-group account-form__group">
            <label class="col-sm-2 control-label account-form__label"><?php echo $entry_default; ?></label>
            <div class="col-sm-10">
              <?php if ($default) { ?>
...
$('.form-group account-form__group[data-sort]').detach().each(function() {
	if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('.form-group account-form__group').length-2) {
		$('.form-group account-form__group').eq(parseInt($(this).attr('data-sort'))+2).before(this);
	}

	if ($(this).attr('data-sort') > $('.form-group account-form__group').length-2) {
