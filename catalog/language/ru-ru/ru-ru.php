<?php
// Error
$_['contact_error_name']    = 'Имя должно быть от 2 до 32 символов!';
$_['contact_error_email']   = 'Email адрес введен неверно!';
$_['contact_error_enquiry'] = 'Длина текста должна быть от 10 до 3000 символов!';
$_['contact_error_captcha'] = 'Проверочный код не совпадает с изображением!';

$_['faq_error_name']        = 'Имя должно быть от 2 до 32 символов!';
$_['faq_error_email']       = 'Email адрес введен неверно!';
$_['faq_error_title']       = 'Длина текста должна быть от 10 до 3000 символов!';

$_['review_error_name']     = 'Имя должно быть от 2 до 32 символов!';
$_['review_error_email']    = 'Email адрес введен неверно!';
$_['review_error_title']    = 'Длина текста должна быть от 10 до 3000 символов!';

$_['request_error_name']    = 'Имя должно быть от 2 до 32 символов!';
$_['request_error_tel']     = 'Телефон обязателен!';

$_['question_error_name']    = 'Имя от 2 до 32 символов!';
$_['question_error_tel']     = 'Телефон обязателен!';

// Error
$_['login_error_email']     = 'Неправильно заполнено поле телефон';
$_['login_error_password']  = 'Неправильно заполнены поле пароль';
$_['login_error_attempts']  = 'Вы превысили максимальное количество попыток авторизации. Повторите попытку авторизации на сайте через 1 час';
$_['login_error_approved']  = 'Необходимо подтвердить аккаунт перед авторизацией.';
