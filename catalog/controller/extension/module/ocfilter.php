...
class ControllerExtensionModuleOCFilter extends Controller {
    ...
    public function index($settings = array()) {
        ...
        $template = 'extension/module/ocfilter';

        $this->document->addStyle('/javascript/ocfilter/nouislider.min.css');
//        $this->document->addStyle('/stylesheet/ocfilter/ocfilter.css');

        $this->document->addScript('/javascript/ocfilter/nouislider.min.js');
        $this->document->addScript('/javascript/ocfilter/ocfilter.js');
