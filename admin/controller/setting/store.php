...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['config_reg_email'])) {
			...
			$data['config_reg_email'] = $store_info['config_reg_email'];
		} else {
			$data['config_reg_email'] = '';
		}

		if (isset($this->request->post['config_sale_email'])) {
			$data['config_sale_email'] = $this->request->post['config_sale_email'];
		} elseif (isset($store_info['config_email'])) {
			$data['config_sale_email'] = $store_info['config_sale_email'];
		} else {
			$data['config_sale_email'] = '';
		}
		...
		} elseif (isset($store_info['config_telephone_2'])) {
			$data['config_telephone_2'] = $store_info['config_telephone_2'];
		} else {
			$data['config_telephone_2'] = '';
		}
		...
		if (isset($this->request->post['config_you'])) {
			$data['config_you'] = $this->request->post['config_you'];
		} elseif (isset($store_info['config_you'])) {
			$data['config_you'] = $store_info['config_you'];
		} else {
			$data['config_you'] = '';
		}
		...
		} elseif (isset($store_info['config_in'])) {
			$data['config_in'] = $store_info['config_in'];
		} else {
			$data['config_in'] = '';
		}
		...
		foreach ($data['languages'] as $language) {
			if (isset($this->request->post['config_fields'][$language['language_id']]['filed_1'])) {
				$data['config_fields'][$language['language_id']]['filed_1'] = $this->request->post['config_fields'][$language['language_id']]['filed_1'];
			} else {
				$data['config_fields'][$language['language_id']]['filed_1'] = $this->config->get('config_fields')[$language['language_id']]['filed_1'];
			}

			/**
			 * Legend field's
			 */
			if (isset($this->request->post['config_fields'][$language['language_id']]['img_legend_1'])) {
				$data['config_fields'][$language['language_id']]['img_legend_1'] = $this->request->post['config_fields'][$language['language_id']]['img_legend_1'];
			} else {
				$data['config_fields'][$language['language_id']]['img_legend_1'] = $this->config->get('config_fields')[$language['language_id']]['img_legend_1'];
			}

			if (isset($this->request->post['config_fields'][$language['language_id']]['img_legend_1']) && is_file(DIR_IMAGE . $this->request->post['config_fields'][$language['language_id']]['img_legend_1'])) {
				$data['config_fields'][$language['language_id']]['thumb_legend_1'] = $this->model_tool_image->resize($this->request->post['config_fields'][$language['language_id']]['img_legend_1'], 100, 100);
			} elseif ($this->config->get('config_fields')[$language['language_id']]['img_legend_1'] && is_file(DIR_IMAGE . $this->config->get('config_fields')[$language['language_id']]['img_legend_1'])) {
				$data['config_fields'][$language['language_id']]['thumb_legend_1'] = $this->model_tool_image->resize($this->config->get('config_fields')[$language['language_id']]['img_legend_1'], 100, 100);
			} else {
				$data['config_fields'][$language['language_id']]['thumb_legend_1'] = $this->model_tool_image->resize('no_image.png', 100, 100);
			}

			if (isset($this->request->post['config_fields'][$language['language_id']]['filed_legend_1'])) {
				$data['config_fields'][$language['language_id']]['filed_legend_1'] = $this->request->post['config_fields'][$language['language_id']]['filed_legend_1'];
			} else {
				$data['config_fields'][$language['language_id']]['filed_legend_1'] = $this->config->get('config_fields')[$language['language_id']]['filed_legend_1'];
			}

			if (isset($this->request->post['config_fields'][$language['language_id']]['filed_legend_2'])) {
				$data['config_fields'][$language['language_id']]['filed_legend_2'] = $this->request->post['config_fields'][$language['language_id']]['filed_legend_2'];
			} else {
				$data['config_fields'][$language['language_id']]['filed_legend_2'] = $this->config->get('config_fields')[$language['language_id']]['filed_legend_2'];
			}

			if (isset($this->request->post['config_fields'][$language['language_id']]['filed_legend_3'])) {
				$data['config_fields'][$language['language_id']]['filed_legend_3'] = $this->request->post['config_fields'][$language['language_id']]['filed_legend_3'];
			} else {
				$data['config_fields'][$language['language_id']]['filed_legend_3'] = $this->config->get('config_fields')[$language['language_id']]['filed_legend_3'];
			}

			if (isset($this->request->post['config_fields'][$language['language_id']]['filed_legend_4'])) {
				$data['config_fields'][$language['language_id']]['filed_legend_4'] = $this->request->post['config_fields'][$language['language_id']]['filed_legend_4'];
			} else {
				$data['config_fields'][$language['language_id']]['filed_legend_4'] = $this->config->get('config_fields')[$language['language_id']]['filed_legend_4'];
			}

			if (isset($this->request->post['config_fields'][$language['language_id']]['filed_legend_5'])) {
				$data['config_fields'][$language['language_id']]['filed_legend_5'] = $this->request->post['config_fields'][$language['language_id']]['filed_legend_5'];
			} else {
				$data['config_fields'][$language['language_id']]['filed_legend_5'] = $this->config->get('config_fields')[$language['language_id']]['filed_legend_5'];
			}
		}
