...
class ControllerCustomerCustomer extends Controller {
	...
	public function addHistory() {
		...
		if (!$this->user->hasPermission('modify', 'customer/customer')) {
			...
			$this->model_customer_customer->addHistory($this->request->get['customer_id'], $this->request->post['comment'], $this->request->post['title']);
	...
	public function deletehistory() {
		...
		if (!$this->user->hasPermission('modify', 'customer/customer')) {
			...
			$this->model_customer_customer->deleteHistory((int)$this->request->get['customer_id'], (int)$this->request->get['history_id']);
