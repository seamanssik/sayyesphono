...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($showroom) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_showroom'),
					'href'     => '',
					'children' => $showroom
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/photodays_category')) {
				$photodays[] = array(
					'name'	   => $this->language->get('text_photodays_category'),
					'href'     => $this->url->link('catalog/photodays_category', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			
			if ($this->user->hasPermission('access', 'catalog/photodays_product')) {
				$photodays[] = array(
					'name'	   => $this->language->get('text_photodays_product'),
					'href'     => $this->url->link('catalog/photodays_product', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($photodays) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_photodays'),
					'href'     => '',
					'children' => $photodays
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/legend')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_legend'),
					'href'     => $this->url->link('catalog/legend', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/promotags')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_promotags'),
					'href'     => $this->url->link('catalog/promotags', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/faq_testimonial')) {
				$faq[] = array(
					'name'	   => 'FAQ',
					'href'     => $this->url->link('extension/module/faq_testimonial/listing', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'extension/module/faq_reviews')) {
				$faq[] = array(
					'name'	   => 'Отзывы',
					'href'     => $this->url->link('extension/module/faq_reviews/listing', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
