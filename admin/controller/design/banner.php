...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		$layout = 'banner_form';
		switch ($data['banner_id']) {
			case 14:
				$layout = 'banner_form_14';
				break;
			case 24:
				$layout = 'banner_form_14';
				break;
			case 16:
				$layout = 'banner_form_16';
				break;
			case 27:
				$layout = 'banner_form_16';
				break;
			case 17:
				$layout = 'banner_form_17';
				break;
			case 28:
				$layout = 'banner_form_17';
				break;
			case 18:
				$layout = 'banner_form_18';
				break;
			case 19:
				$layout = 'banner_form_19';
				break;
			case 29:
				$layout = 'banner_form_19';
				break;
			case 20:
				$layout = 'banner_form_20';
				break;
			case 31:
				$layout = 'banner_form_20';
				break;
			case 22:
				$layout = 'banner_form_22';
				break;
			case 30:
				$layout = 'banner_form_22';
				break;
