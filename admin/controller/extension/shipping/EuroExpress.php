<?php
class ControllerExtensionShippingEuroExpress extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('extension/shipping/EuroExpress');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/EuroExpress', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('extension/shipping/EuroExpress', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/shipping/EuroExpress', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/shipping/EuroExpress')) {
