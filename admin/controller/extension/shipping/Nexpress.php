...
class ControllerExtensionShippingNexpress extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/Nexpress', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('extension/shipping/Nexpress', 'token=' . $this->session->data['token'], 'SSL');
