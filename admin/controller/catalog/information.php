...
class ControllerCatalogInformation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if ( !empty($this->request->post['custom_field']) ) {
				...
				$this->model_catalog_information->editCustomFields($information_id, $json_custom_fields);
			} else {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if ( !empty($this->request->post['custom_field']) ) {
				$json_custom_fields = json_encode($this->request->post['custom_field'], JSON_UNESCAPED_UNICODE);
				$this->model_catalog_information->editCustomFields($this->request->get['information_id'], $json_custom_fields);
			} else {
				$json_custom_fields = false;
				$this->model_catalog_information->editCustomFields($this->request->get['information_id'], $json_custom_fields);
			}
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$information_store = $this->model_catalog_information->getInformationStores($result['information_id']);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['custom_field'])) {
			...
			$custom_fields = $this->model_catalog_information->getInformationCustomFields($this->request->get['information_id']);
