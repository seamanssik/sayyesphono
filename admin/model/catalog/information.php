...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', top = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `left` = '" . (isset($data['left']) ? (int)$data['left'] : 0) . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "'");
	...
	public function editInformation($information_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', top = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `left` = '" . (isset($data['left']) ? (int)$data['left'] : 0) . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "' WHERE information_id = '" . (int)$information_id . "'");
	...
	public function getInformationCustomFields($information_id) {
		$query = $this->db->query("SELECT custom_field FROM " . DB_PREFIX . "information WHERE information_id = '" . (int)$information_id . "'");

		return $query->row['custom_field'];
	}

	public function editCustomFields($information_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "information SET custom_field = '" . $this->db->escape($data) . "' WHERE information_id = '" . (int)$information_id . "'");
