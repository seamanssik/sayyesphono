...
class ModelCustomerCustomer extends Model {
	...
	public function addHistory($customer_id, $comment, $title) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_history SET customer_id = '" . (int)$customer_id . "', title = '" . $this->db->escape($title) . "', comment = '" . $this->db->escape($comment) . "', date_added = NOW()");
	}

	public function deleteHistory($customer_id, $history_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "customer_history WHERE customer_id = '" . (int)$customer_id . "' AND customer_history_id = '" . (int)$history_id . "'");
	}
	...
	public function getHistories($customer_id, $start = 0, $limit = 10) {
		...
		$query = $this->db->query("SELECT customer_history_id, title, comment, date_added FROM " . DB_PREFIX . "customer_history WHERE customer_id = '" . (int)$customer_id . "' ORDER BY date_added DESC LIMIT " . (int)$start . "," . (int)$limit);
