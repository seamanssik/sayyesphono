                ...
                <tbody>
                    <?php foreach ($topics as $topic) { ?>
                        <tr>
                            ...
                            <td class="text-right">
                                <button onclick="getTopicReviews(<?php echo $topic['topic_id']; ?>);" class="btn btn-primary">Редактировать</button>
                                <button onclick="deleteTopicReviews(<?php echo $topic['topic_id']; ?>);" class="btn btn-danger">Удалить</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
