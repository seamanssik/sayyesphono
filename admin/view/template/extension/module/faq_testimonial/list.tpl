  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <?php /* ?><a href="#" onclick="getTopic(0); return false;" class="btn btn-info">Добавить раздел</a>
        <a href="#" onclick="listTopic(); return false;" class="btn btn-warning">Разделы FAQ</a><?php */ ?>
