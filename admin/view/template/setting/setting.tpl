      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-home" data-toggle="tab">Главная</a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane" id="tab-home">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab-home-showroom" data-toggle="tab">Showroom</a></li>
                <li><a href="#tab-home-legend" data-toggle="tab">Легенда</a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane active" id="tab-home-showroom">
                    ...
                    <?php foreach ($languages as $language) { ?>
                      <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-fields-<?php echo $language['language_id']; ?>-filed-1">Описание Showroom</label>
                          <div class="col-sm-10">
                            <textarea name="config_fields[<?php echo $language['language_id']; ?>][filed_1]" id="input-fields-<?php echo $language['language_id']; ?>-filed-1" class="form-control summernote"><?php echo $config_fields[$language['language_id']]['filed_1']; ?></textarea>
                          </div>
                        </div>
                      </div>
                    <?php } ?>
                ...
                <div class="tab-pane" id="tab-home-legend">
                  <ul class="nav nav-tabs" id="language-legend">
                    <?php foreach ($languages as $language) { ?>
                      <li><a href="#language-legend<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                    <?php } ?>
                  </ul>
                  <div class="tab-content">
                    <?php foreach ($languages as $language) { ?>
                      <div class="tab-pane" id="language-legend<?php echo $language['language_id']; ?>">
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-legend-image">Фотография</label>
                          <div class="col-sm-10">
                            <a href="" id="thumb-img-legend-1" data-toggle="image" class="img-thumbnail"><img src="<?php echo $config_fields[$language['language_id']]['thumb_legend_1']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                            <input type="hidden" name="config_fields[<?php echo $language['language_id']; ?>][img_legend_1]" value="<?php echo $config_fields[$language['language_id']]['img_legend_1']; ?>" id="input-img-legend-1" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-fields-<?php echo $language['language_id']; ?>-filed-legend-1">Заголовок</label>
                          <div class="col-sm-10">
                            <input type="text" name="config_fields[<?php echo $language['language_id']; ?>][filed_legend_1]" value="<?php echo $config_fields[$language['language_id']]['filed_legend_1']; ?>" id="input-fields-<?php echo $language['language_id']; ?>-filed-legend-1" class="form-control" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-fields-<?php echo $language['language_id']; ?>-filed-legend-2">Цытата</label>
                          <div class="col-sm-10">
                            <input type="text" name="config_fields[<?php echo $language['language_id']; ?>][filed_legend_2]" value="<?php echo $config_fields[$language['language_id']]['filed_legend_2']; ?>" id="input-fields-<?php echo $language['language_id']; ?>-filed-legend-2" class="form-control" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-fields-<?php echo $language['language_id']; ?>-filed-legend-3">Автор</label>
                          <div class="col-sm-10">
                            <input type="text" name="config_fields[<?php echo $language['language_id']; ?>][filed_legend_3]" value="<?php echo $config_fields[$language['language_id']]['filed_legend_3']; ?>" id="input-fields-<?php echo $language['language_id']; ?>-filed-legend-3" class="form-control" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-fields-<?php echo $language['language_id']; ?>-filed-legend-5">Ссылка</label>
                          <div class="col-sm-10">
                            <input type="text" name="config_fields[<?php echo $language['language_id']; ?>][filed_legend_5]" value="<?php echo $config_fields[$language['language_id']]['filed_legend_5']; ?>" id="input-fields-<?php echo $language['language_id']; ?>-filed-legend-5" class="form-control" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-fields-<?php echo $language['language_id']; ?>-filed-legend-4">Описание</label>
                          <div class="col-sm-10">
                            <textarea name="config_fields[<?php echo $language['language_id']; ?>][filed_legend_4]" id="input-fields-<?php echo $language['language_id']; ?>-filed-legend-4" class="form-control summernote"><?php echo $config_fields[$language['language_id']]['filed_legend_4']; ?></textarea>
                          </div>
                        </div>
                      </div>
                    <?php } ?>
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-vk">Ссылка Вконтакте</label>
                <div class="col-sm-10">
                  <input type="text" name="config_vk" value="<?php echo $config_vk; ?>" placeholder="Ссылка Вконтакте" id="input-vk" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-fb">Ссылка Facebook</label>
                <div class="col-sm-10">
                  <input type="text" name="config_fb" value="<?php echo $config_fb; ?>" placeholder="Ссылка Вконтакте" id="input-fb" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-you">Ссылка YouTube</label>
                <div class="col-sm-10">
                  <input type="text" name="config_you" value="<?php echo $config_you; ?>" placeholder="Ссылка Вконтакте" id="input-you" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-in">Ссылка Instagram</label>
                <div class="col-sm-10">
                  <input type="text" name="config_in" value="<?php echo $config_in; ?>" placeholder="Ссылка Вконтакте" id="input-in" class="form-control" />
                </div>
              </div>
...
//--></script>
  ...
  <script type="text/javascript">
    ...
    $('#language-legend a:first').tab('show');
  </script>
</div>
<?php echo $footer; ?> 
