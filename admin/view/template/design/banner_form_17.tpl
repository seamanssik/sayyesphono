              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left">
                      <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][link]" />
                      <textarea name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" placeholder="<?php echo $entry_title; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo $banner_image['title']; ?></textarea>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <div class="col-sm-12">
                              <label for="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_1" class="control-label" style="padding: 0 0 7px">Дата</label>
                              <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][field_1]" value="<?php echo $banner_image['field_1']; ?>" class="form-control" id="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_1" />
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <div class="col-sm-12">
                              <label for="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_2" class="control-label" style="padding: 0 0 7px">Город</label>
                              <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][field_2]" value="<?php echo $banner_image['field_2']; ?>" class="form-control" id="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_2" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <td class="text-center">
                      <a href="" id="thumb-image-<?php echo $image_row; ?>-field_3" data-toggle="image" class="img-thumbnail" style="background: #ccc;"><img width="100" height="100" src="/image/<?php echo $banner_image['field_3']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                      <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][field_3]" value="<?php echo $banner_image['field_3']; ?>" id="input-image<?php echo $image_row; ?>-field_3" />
                    </td>
...
function addImage(language_id) {
  ...
  html += '    <input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][link]" />';
  html += '    <textarea name="banner_image[' + language_id + '][' + image_row + '][title]" placeholder="<?php echo $entry_title; ?>" id="input-description' + language_id + '" class="form-control summernote"></textarea>';
  html += '    <div class="row">';
  html += '      <div class="col-sm-6">';
  html += '       <div class="form-group">';
  html += '         <div class="col-sm-12">';
  html += '           <label for="banner_image-' + language_id + '-' + image_row + '-field_1" class="control-label" style="padding: 0 0 7px">Дата</label>';
  html += '           <input type="text" name="banner_image[' + language_id + '][' + image_row + '][field_1]" class="form-control" id="banner_image-' + language_id + '-' + image_row + '-field_1" />';
  html += '         </div>';
  html += '       </div>';
  html += '      </div>';
  html += '      <div class="col-sm-6">';
  html += '        <div class="form-group">';
  html += '          <div class="col-sm-12">';
  html += '            <label for="banner_image-' + language_id + '-' + image_row + '-field_2" class="control-label" style="padding: 0 0 7px">Город</label>';
  html += '            <input type="text" name="banner_image[' + language_id + '][' + image_row + '][field_2]" class="form-control" id="banner_image-' + language_id + '-' + image_row + '-field_2" />';
  html += '          </div>';
  html += '        </div>';
  html += '      </div>';
  html += '    </div>';
