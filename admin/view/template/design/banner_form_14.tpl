                    ...
                    <td class="text-left">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <div class="col-sm-12">
                              <label for="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_1" class="control-label" style="padding: 0 0 7px">Имя</label>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <div class="col-sm-12">
                              <label for="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_2" class="control-label" style="padding: 0 0 7px">Должность</label>
...
function addImage(language_id) {
  ...
  html += '           <label for="banner_image-' + language_id + '-' + image_row + '-field_1" class="control-label" style="padding: 0 0 7px">Имя</label>';
  ...
  html += '        <div class="form-group">';
  html += '          <div class="col-sm-12">';
  html += '            <label for="banner_image-' + language_id + '-' + image_row + '-field_2" class="control-label" style="padding: 0 0 7px">Должность</label>';
