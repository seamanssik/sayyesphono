            ...
            <table id="route" class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="route-row<?php echo $route_row; ?>">
                  ...
                  <td class="text-left"><input type="text" name="layout_route[<?php echo $route_row; ?>][template]" value="<?php echo $layout_route['template']; ?>" placeholder="Template" class="form-control" /></td>
...
function addRoute() {
	...
	html += '  <td class="text-left"><input type="text" name="layout_route[' + route_row + '][template]" value="" placeholder="Template" class="form-control" /></td>';
