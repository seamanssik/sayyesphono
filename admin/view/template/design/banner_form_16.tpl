                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left">
                      <div class="form-group" style="padding-top: 0">
                        <div class="col-sm-12">
                          <input placeholder="Заголовок" type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][field_1]" value="<?php echo $banner_image['field_1']; ?>" class="form-control" id="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_1" />
                        </div>
                      </div>
...
function addImage(language_id) {
    ...
    html += '        <input placeholder="Заголовок" type="text" name="banner_image[' + language_id + '][' + image_row + '][field_1]"  class="form-control" id="banner_image-' + language_id + '-' + image_row + '-field_1" />';
    html += '      </div>';
    html += '    </div>';
