...
<div id="content">
                  ...
                  <?php if (isset($banner_images[$language['language_id']])) { ?>
                    <?php foreach ($banner_images[$language['language_id']] as $banner_image) { ?>
                      <tr id="image-row<?php echo $image_row; ?>">
                        <td class="text-left">
                          <input type="text" placeholder="Модель" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" value="<?php echo $banner_image['title']; ?>" class="form-control" id="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-title" />
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <input type="text" placeholder="Фотосессия" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][field_1]" value="<?php echo $banner_image['field_1']; ?>" class="form-control" id="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_1" />
                            </div>
                          </div>
                        </td>
                        <td class="text-left" style="width: 30%;">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <input type="text" placeholder="Текст ссылки" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][field_2]" value="<?php echo $banner_image['field_2']; ?>" class="form-control" id="banner_image-<?php echo $language['language_id']; ?>-<?php echo $image_row; ?>-field_2" />
                            </div>
                          </div>
                        </td>
  ...
  <script type="text/javascript"><!--
    ...
    function addImage(language_id) {
      ...
      html += '    <input type="text" placeholder="Модель" name="banner_image[' + language_id + '][' + image_row + '][title]" class="form-control" id="banner_image-' + language_id + '-' + image_row + '-title" />';
      html += '       <div class="form-group">';
      html += '         <div class="col-sm-12">';
      html += '           <input type="text" placeholder="Фотосессия" name="banner_image[' + language_id + '][' + image_row + '][field_1]" class="form-control" id="banner_image-' + language_id + '-' + image_row + '-field_1" />';
      html += '         </div>';
      html += '       </div>';
      html += '  </td>';
      ...
      html += '        <div class="form-group">';
      html += '          <div class="col-sm-12">';
      html += '            <input type="text" placeholder="Текст ссылки" name="banner_image[' + language_id + '][' + image_row + '][field_2]" class="form-control" id="banner_image-' + language_id + '-' + image_row + '-field_2" />';
      html += '          </div>';
      html += '        </div>';
      html += '  </td>';
