...
<script src="view/javascript/jquery/datetimepicker/bootstrap-datepicker.js" type="text/javascript"></script>
<script src="view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<link href="view/javascript/jquery/datetimepicker/bootstrap-datepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
    <li><a href="<?php echo $deadcow_seo; ?>">Deadcow_seo</a></li>
