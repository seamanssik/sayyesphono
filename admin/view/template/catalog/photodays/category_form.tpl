            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="photodays_parent_id" value="<?php echo $photodays_parent_id; ?>" />
                  <?php if ($error_parent) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top">Отображать вверху</label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($top) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="Отображать слева">Отображать слева</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($left) { ?>
                        <input type="checkbox" name="left" value="1" checked="checked" id="input-top" />
                      <?php } else { ?>
                        <input type="checkbox" name="left" value="1" id="input-top" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom"><span data-toggle="tooltip" title="Отображать внизу">Отображать внизу</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom) { ?>
...
$('input[name=\'path\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/photodays_category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				...
				response($.map(json, function(item) {
					return {
						label: item['name'],
						value: item['photodays_category_id']
					}
				}));
			}
		});
	...
	'select': function(item) {
		...
		$('input[name=\'photodays_parent_id\']').val(item['value']);
	}
});
//--></script>
  <script type="text/javascript"><!--
