			...
			<?php if ($news) { ?>
				...
				<?php foreach ($news as $news_story) { ?>
					...
					<tr class="<?php echo $class; ?>">
						...
						<td class="text-left"><?php echo $news_story['status']; ?></td>
						<td class="text-left">
							<?php if (in_array(0, $news_story['news_store'])) { ?>
								<p style="margin: 0"><span class="label label-primary"><?php echo 'Основной магазин'; ?></span></p>
							<?php } ?>
							<?php foreach ($news_story['stores'] as $store) { ?>
								<?php if (in_array($store['store_id'], $news_story['news_store'])) { ?>
