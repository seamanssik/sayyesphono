...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-ncategory').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
	  ...
	  <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-ncategory">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($ncategory['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="text-left"><?php echo $ncategory['name']; ?></td>
              <td class="text-right"><?php echo $ncategory['sort_order']; ?></td>
              <td class="text-right"><?php foreach ($ncategory['action'] as $action) { ?>
