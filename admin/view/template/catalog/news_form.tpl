...
<div id="content">
                                ...
                                <?php foreach ($languages as $language) { ?>
                                    <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="news_description[<?php echo $language['language_id']; ?>][cfield1]" id="input-cfield1<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset( $news_description[$language['language_id']]['cfield1']) ? $news_description[$language['language_id']]['cfield1'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="tab-pane" id="languagesc<?php echo $language['language_id']; ?>">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="news_description[<?php echo $language['language_id']; ?>][cfield2]" id="input-cfield2<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset( $news_description[$language['language_id']]['cfield2']) ? $news_description[$language['language_id']]['cfield2'] : ''; ?></textarea>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane" id="tab-video">
                            <div class="table-responsive">
                                <table id="video" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <?php foreach ($languages as $language) { ?>
                                                    ...
                                                    <textarea class="form-control" name="news_video[<?php echo $video_row; ?>][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"><?php echo isset($video['text'][$language['language_id']]) ? $video['text'][$language['language_id']] : '' ; ?></textarea><br />
                                                <?php } ?>
                                            </td>
                                            <td class="text-left"><input type="text" name="news_video[<?php echo $video_row; ?>][width]" value="<?php echo $video['width']; ?>" size="3" />
                                                <input class="form-control" type="text" name="news_video[<?php echo $video_row; ?>][height]" value="<?php echo $video['height']; ?>" size="3" />
                                            </td>
                                            ...
                                            <td class="text-left"><a onclick="$('#video-row<?php echo $video_row; ?>').remove();" class="btn btn-danger sterge"><?php echo $button_remove; ?></a></td>
                                        </tr>
                                        </tbody>
                                        <?php $video_row++; ?>
                                    <?php } ?>
                                    ...
                                    <tr>
                                        <td colspan="4"></td>
                                        <td class="text-left"><a onclick="addVideo();" class="btn btn-primary"><?php echo $button_add_video; ?></a></td>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-gallery">
                            ...
                            <div class="table-responsive">
                                <table id="gallery" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php foreach ($news_gallery as $news_image) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <?php foreach ($languages as $language) { ?>
                                                    <img style="margin: 10px;" src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
                                                    <textarea class="form-control" name="news_gallery[<?php echo $image_row; ?>][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"><?php echo isset($news_image['text'][$language['language_id']]) ? $news_image['text'][$language['language_id']] : '' ; ?></textarea><br />
                                                <?php } ?>
                                            </td>
                                            <td class="text-right"><input type="text"  class="form-control" name="news_gallery[<?php echo $image_row; ?>][sort_order]" value="<?php echo $news_image['sort_order']; ?>" size="2" /></td>
                                            <td class="text-left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="btn btn-danger sterge"><?php echo $button_remove; ?></a></td>
                                        </tr>
                                        </tbody>
                                        <?php $image_row++; ?>
                                    <?php } ?>
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td class="left"><a onclick="addGallery();" class="btn btn-primary"><?php echo $button_add_image; ?></a></td>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="left"><select name="news_layout[0]" class="form-control">
                                                <option value=""></option>
                                    ...
                                    <?php foreach ($stores as $store) { ?>
                                        <tr>
                                            ...
                                            <td class="left"><select name="news_layout[<?php echo $store['store_id']; ?>]" class="form-control">
                                                    <option value=""></option>
                                                    <?php foreach ($layouts as $layout) { ?>
    ...
    <script type="text/javascript"><!--
        ...
        function addGallery() {
            ...
            <?php foreach ($languages as $language) { ?>
            html += '	<img style="margin: 10px;" src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea class="form-control" name="news_gallery[' + image_row  + '][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"></textarea><br />';
            <?php } ?>
            html += '</td>';
            html += '    <td class="text-right"><input class="form-control" type="text" name="news_gallery[' + image_row + '][sort_order]" value="" size="2" /></td>';
            html += '    <td class="text-left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="btn btn-danger sterge"><?php echo $button_remove; ?></a></td>';
            html += '  </tr>';
            html += '</tbody>';
        ...
        function addVideo() {
            ...
            html += '  <tr>';
            html += '    <td class="left"><input class="form-control" type="text" name="news_video[' + video_row + '][video]" value="" size="20" /></td>';
            html += '    <td class="left">';
            <?php foreach ($languages as $language) { ?>
            html += '	<img style="margin: 10px;" src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea class="form-control" name="news_video[' + video_row  + '][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"></textarea><br />';
            <?php } ?>
            html += '</td>';
            html += '    <td class="left"><input class="form-control" type="text" name="news_video[' + video_row + '][width]" placeholder="width" value="" size="3" /><input class="form-control" type="text" name="news_video[' + video_row + '][height]" placeholder="height" value="" size="3" /></td>';
            html += '    <td class="right"><input class="form-control" type="text" name="news_video[' + video_row + '][sort_order]" value="" size="2" /></td>';
            html += '    <td class="left"><a onclick="$(\'#video-row' + video_row  + '\').remove();" class="btn btn-danger sterge"><?php echo $button_remove; ?></a></td>';
            html += '  </tr>';
            html += '</tbody>';
