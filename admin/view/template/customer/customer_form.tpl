      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <?php if ($customer_id) { ?>
            <li><a href="#tab-history" data-toggle="tab">Фотосессии<?php // echo $tab_history; ?></a></li>
            <li class="hidden"><a href="#tab-transaction" data-toggle="tab"><?php echo $tab_transaction; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-history">
              ...
              <br />
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-history-title">Название</label>
                <div class="col-sm-10">
                  <input type="text" name="history_title" placeholder="Название" id="input-history-title" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-comment">Ссылка</label>
                <div class="col-sm-10">
                  <textarea name="comment" rows="8" placeholder="Ссылка" id="input-comment" class="form-control"></textarea>
                </div>
              </div>
...
$('#button-history').on('click', function(e) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'comment=' + encodeURIComponent($('#tab-history textarea[name=\'comment\']').val()) + '&title=' + encodeURIComponent($('#tab-history input[name=\'history_title\']').val()),
		beforeSend: function() {
...
//--></script>
  <script type="text/javascript"><!--
$(document).on('click', '#button-historyDelete', function(e) {
	e.preventDefault();

    var history_id = $(this).attr('data-history-id');

	$.ajax({
		url: 'index.php?route=customer/customer/deletehistory&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>&history_id=' + history_id,
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#button-history').button('loading');
