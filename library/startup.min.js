...
jQuery.fn.exist = function () {
    ...
    $(document).on("click", "#button-cart", function () {
        $.ajax({
            ...
            dataType: "json",
            success: function (e) {
                e.success && (_body.find("#modalSuccess .modalSuccess-text").html(e.success), _body.find("#modalSuccess").modal("show"), _body.find('*[data-toggle="cart-total"]').removeClass("hidden").text(e.total))
            }
        })
    })
}), $(document).ready(function () {
    ...
    if (o.exist()) {
        ...
        t.detach().appendTo(a), $.each(o.find('*[data-toggle="legend-item"]'), function (e) {
    ...
    if (p) {
        ...
        var f = function () {
            var e = $("#contactMap"), t = 49.9999114, a = 36.2346487;
            if (e.length >= 1) {
