"function" != typeof Object.create && (Object.create = function (e) {
    ...
    var n = {
        init: function (t, i) {
            ...
            var e = this;
            e.$elem.data("owl-originalStyles", e.$elem.attr("style")), e.$elem.data("owl-originalClasses", e.$elem.attr("class")), e.$elem.css({opacity: 0}), e.orignalItems = e.options.items, e.checkBrowser(), e.wrapperWidth = 0, e.checkVisible = null, e.setVars()
        }, setVars: function () {
            var e = this;
            ...
            var i, n, o = this;
            return o.options.responsive !== !0 ? !1 : (n = e(t).width(), o.resizer = function () {
            ...
            t.$owlItems.each(function (o) {
                var s = e(this);
                s.css({width: t.itemWidth}).data("owl-item", Number(o)), (o % t.options.items === 0 || o === n) && (o > n || (i += 1)), s.data("owl-roundPages", i)
            })
            ...
            var t, i, n, o = this, s = 0, r = 0;
            for (o.positionsInArray = [0], o.pagesInArray = [], t = 0; t < o.itemsAmount; t += 1)r += o.itemWidth, o.positionsInArray.push(-r), o.options.scrollPerPage === !0 && (i = e(o.$owlItems[t]), n = i.data("owl-roundPages"), n !== s && (o.pagesInArray[s] = o.positionsInArray[t], s = n))
            ...
            for (a.paginationWrapper.html(""), t = 0, i = a.itemsAmount - a.itemsAmount % a.options.items, o = 0; o < a.itemsAmount; o += 1)o % a.options.items === 0 && (t += 1, i === o && (n = a.itemsAmount - a.options.items), s = e("<div/>", {"class": "owl-page"}), r = e("<span></span>", {
                text: a.options.paginationNumbers === !0 ? t : "",
                "class": a.options.paginationNumbers === !0 ? "owl-numbers" : ""
            }), s.append(r), s.data("owl-page", i === o ? n : o), s.data("owl-roundPages", t), a.paginationWrapper.append(s));
            a.checkPagination()
            ...
            return s.isTransition ? !1 : ("function" == typeof s.options.beforeMove && s.options.beforeMove.apply(this, [s.$elem]), e >= s.maximumItem ? e = s.maximumItem : 0 >= e && (e = 0), s.currentItem = s.owl.currentItem = e, s.options.transitionStyle !== !1 && "drag" !== n && 1 === s.options.items && s.browser.support3d === !0 ? (s.swapSpeed(0), s.browser.support3d === !0 ? s.transition3d(s.positionsInArray[e]) : s.css2slide(s.positionsInArray[e], 1), s.afterGo(), s.singleItemTransition(), !1) : (o = s.positionsInArray[e], s.browser.support3d === !0 ? (s.isCss3Finish = !1, i === !0 ? (s.swapSpeed("paginationSpeed"), t.setTimeout(function () {
                s.isCss3Finish = !0
            }, s.options.paginationSpeed)) : "rewind" === i ? (s.swapSpeed(s.options.rewindSpeed), t.setTimeout(function () {
                s.isCss3Finish = !0
            ...
            var e, n, o, s, r = this, a = "translate3d(0px, 0px, 0px)", l = i.createElement("div");
            l.style.cssText = "  -moz-transform:" + a + "; -ms-transform:" + a + "; -o-transform:" + a + "; -webkit-transform:" + a + "; transform:" + a, e = /translate3d\(0px, 0px, 0px\)/g, n = l.style.cssText.match(e), o = null !== n && 1 === n.length, s = "ontouchstart" in t || t.navigator.msMaxTouchPoints, r.browser = {
                support3d: o,
                isTouch: s
            }
        }, moveEvents: function () {
            ...
            function o(t) {
                "on" === t ? (e(i).on(l.ev_types.move, r), e(i).on(l.ev_types.end, a)) : "off" === t && (e(i).off(l.ev_types.move), e(i).off(l.ev_types.end))
            }
            ...
            function r(o) {
                var s, r, a = o.originalEvent || o || t.event;
            ...
            function a(i) {
                var n, s, r, a = i.originalEvent || i || t.event;
                a.target = a.target || a.srcElement, u.dragging = !1, l.browser.isTouch !== !0 && l.$owlWrapper.removeClass("grabbing"), l.dragDirection = l.owl.dragDirection = l.newRelativeX < 0 ? "left" : "right", 0 !== l.newRelativeX && (n = l.getNewPosition(), l.goTo(n, !1, "drag"), u.targetElement === a.target && l.browser.isTouch !== !0 && (e(a.target).on("click.disable", function (t) {
                    t.stopImmediatePropagation(), t.stopPropagation(), t.preventDefault(), e(t.target).off("click.disable")
                }), s = e._data(a.target, "events").click, r = s.pop(), s.splice(0, 0, r))), o("off")
            }
            ...
            var t = this, i = t.options.scrollPerPage === !0 ? t.pagesInArray : t.positionsInArray, n = t.newPosX, o = null;
            return e.each(i, function (s, r) {
                n - t.itemWidth / 20 > i[s + 1] && n - t.itemWidth / 20 < r && "left" === t.moveDirection() ? (o = r, t.currentItem = t.options.scrollPerPage === !0 ? e.inArray(o, t.positionsInArray) : s) : n + t.itemWidth / 20 < r && n + t.itemWidth / 20 > (i[s + 1] || i[s] - t.itemWidth) && "right" === t.moveDirection() && (t.options.scrollPerPage === !0 ? (o = i[s + 1] || i[i.length - 1], t.currentItem = e.inArray(o, t.positionsInArray)) : (o = i[s + 1], t.currentItem = s + 1))
            }), t.currentItem
            ...
            function o() {
                a += 1, r.completeImg(i.get(0)) || s === !0 ? n() : 100 >= a ? t.setTimeout(o, 100) : n()
            }
            ...
            var t = this, i = t.outClass, n = t.inClass, o = t.$owlItems.eq(t.currentItem), s = t.$owlItems.eq(t.prevItem), r = Math.abs(t.positionsInArray[t.currentItem]) + t.positionsInArray[t.prevItem], a = Math.abs(t.positionsInArray[t.currentItem]) + t.itemWidth / 2, l = "webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend";
    ...
    }, o = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch, s = /Windows Phone/.test(navigator.userAgent);
    n.isMobileDevice = !(!o && !s);
    var r = function () {
        var t = e("<style>").appendTo("head"), i = t.prop("sheet") || t.prop("styleSheet"), o = function (e, t, n) {
        ...
        var s = e("html"), r = e("body");
        "rtl" !== s.css("direction") && "rtl" !== r.css("direction") || s.addClass(n.rtlClass), s.on("reset", function () {
            setTimeout(function () {
                l.refreshAll()
            }, 0)
    ...
    !function () {
        var t, i = navigator.pointerEnabled || navigator.msPointerEnabled, n = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch, o = {}, s = "jcf-";
        t = i ? {
        ...
        var r = null, a = function (e) {
            var t = Math.abs(e.pageX - r.x), i = Math.abs(e.pageY - r.y), n = 25;
            return n >= t && n >= i ? !0 : void 0
        }, l = function (t) {
            var i = t || window.event, n = null, l = o[i.type];
            if (t = e.event.fix(i), t.type = s + l, i.pointerType)switch (i.pointerType) {
                case 2:
                    t.pointerType = "touch";
                    break;
                case 3:
            ...
            return t.pageX || t.pageY || (n = i.changedTouches ? i.changedTouches[0] : i, t.pageX = n.pageX, t.pageY = n.pageY), "touchend" === i.type && (r = {
                x: t.pageX,
                y: t.pageY
            }), "mouse" === t.pointerType && r && a(t) ? void 0 : (e.event.dispatch || e.event.handle).call(this, t)
        }
    }(), function () {
        var t = ("onwheel" in document || document.documentMode >= 9 ? "wheel" : "mousewheel DOMMouseScroll").split(" "), i = "jcf-mousewheel";
        e.event.special[i] = {
            setup: function () {
                var i = this;
        ...
        var n = function (t) {
            ...
            if (t = e.event.fix(n), t.type = i, "detail" in n && (t.deltaY = -n.detail), "wheelDelta" in n && (t.deltaY = -n.wheelDelta), "wheelDeltaY" in n && (t.deltaY = -n.wheelDeltaY), "wheelDeltaX" in n && (t.deltaX = -n.wheelDeltaX), "deltaY" in n && (t.deltaY = n.deltaY), "deltaX" in n && (t.deltaX = n.deltaX), t.delta = t.deltaY || t.deltaX, 1 === n.deltaMode) {
                var o = 16;
                t.delta *= o, t.deltaY *= o, t.deltaX *= o
            }
    ...
    var a = {
        ...
        version: t, modules: {}, getOptions: function () {
            ...
            var o = function (t) {
                t.element.data(n.dataKey) || t.element.data(n.dataKey, this), i.push(this), this.options = e.extend({}, n, this.options, s(t.element), t), this.bindHandlers(), this.init.apply(this, arguments)
            }, s = function (t) {
                var i = t.data(n.optionsKey), o = t.attr(n.optionsKey);
                if (i)return i;
                if (o)try {
                    return e.parseJSON(o)
                } catch (s) {
                }
            };
            o.prototype = t, e.extend(t, a), t.plugins && e.each(t.plugins, function (t, i) {
                e.extend(i.prototype, a)
            });
            var r = o.prototype.destroy;
            o.prototype.destroy = function () {
                this.options.element.removeData(this.options.dataKey);
                for (var e = i.length - 1; e >= 0; e--)if (i[e] === this) {
                    i.splice(e, 1);
                    break
                }
                r && r.apply(this, arguments)
            }, this.modules[t.name] = o
        }, getInstance: function (t) {
            return e(t).data(n.dataKey)
        }, replace: function (t, i, o) {
            var s, a = this;
            return n.styleSheetCreated || r(), e(t).each(function () {
                var t, r = e(this);
                s = r.data(n.dataKey), s ? s.refresh() : (i || e.each(a.modules, function (e, t) {
                    return t.prototype.matchElement.call(t.prototype, r) ? (i = e, !1) : void 0
                }), i && (t = e.extend({element: r}, o), s = new a.modules[i](t)))
            }), s
        }, refresh: function (t) {
            e(t).each(function () {
            ...
            var i = this;
            e.each(this.modules, function (n, o) {
                e(o.prototype.selector, t).each(function () {
                    this.className.indexOf("jcf-ignore") < 0 && i.replace(this, n)
                })
            })
        }, refreshAll: function (t) {
            if (t)e.each(this.modules, function (i, o) {
                e(o.prototype.selector, t).each(function () {
                    var t = e(this).data(n.dataKey);
                    t && t.refresh()
                })
            }); else for (var o = i.length - 1; o >= 0; o--)i[o].refresh()
        }, destroyAll: function (t) {
            if (t)e.each(this.modules, function (i, o) {
                e(o.prototype.selector, t).each(function (t, i) {
                    var o = e(i).data(n.dataKey);
                    o && o.destroy()
                })
            }); else for (; i.length;)i[0].destroy()
        }
    };
    return "function" == typeof define && define.amd && (window.jcf = l), l
}), !function (e) {
    e.addModule(function (e, t) {
        ...
        var n = {
            ...
            attachEvents: function () {
                var e = this;
                this.vBar = new i({
                    holder: this.scrollWrapper, vertical: !0, onScroll: function (t) {
                        e.realElement.scrollTop(t)
                    }
                }), this.hBar = new i({
                    holder: this.scrollWrapper, vertical: !1, onScroll: function (t) {
            ...
            onMoveBody: function (e) {
                var t, i, n = this.verticalScrollActive, o = this.horizontalScrollActive;
                "touch" === e.pointerType && (t = this.touchData.scrollTop - e.pageY + this.touchData.top, i = this.touchData.scrollLeft - e.pageX + this.touchData.left, this.verticalScrollActive && (0 > t || t > this.vBar.maxValue) && (n = !1), this.horizontalScrollActive && (0 > i || i > this.hBar.maxValue) && (o = !1), this.realElement.scrollTop(t), this.realElement.scrollLeft(i), n || o ? e.preventDefault() : this.onReleaseBody(e))
            },
            ...
            onMouseWheel: function (e) {
                var t, i, n, o = this.realElement.scrollTop(), s = this.realElement.scrollLeft(), r = this.realElement.prop("scrollHeight") - this.embeddedDimensions.innerHeight, a = this.realElement.prop("scrollWidth") - this.embeddedDimensions.innerWidth;
                (this.options.alwaysPreventMouseWheel || (this.verticalScrollActive && e.deltaY && (0 >= o && e.deltaY < 0 || o >= r && e.deltaY > 0 || (n = !0)), this.horizontalScrollActive && e.deltaX && (0 >= s && e.deltaX < 0 || s >= a && e.deltaX > 0 || (n = !0)), this.verticalScrollActive || this.horizontalScrollActive)) && (n || this.options.alwaysPreventMouseWheel) && (e.preventDefault(), t = e.deltaX / 100 * this.options.mouseWheelStep, i = e.deltaY / 100 * this.options.mouseWheelStep, this.realElement.scrollTop(o + i), this.realElement.scrollLeft(s + t))
            },
            ...
            getEmbeddedDimensions: function (t) {
                var i, n = this.vBar.getThickness(), o = this.hBar.getThickness(), s = this.realElement.outerWidth() - this.realElement.width(), r = this.realElement.outerHeight() - this.realElement.height();
                return this.options.alwaysShowScrollbars ? (this.verticalScrollActive = !0, this.horizontalScrollActive = !0, i = {
                    innerWidth: t.width - n,
                    innerHeight: t.height - o
                    ...
                    innerWidth: t.width - (this.verticalScrollActive ? n : 0),
                    innerHeight: t.height - (this.horizontalScrollActive ? o : 0)
                }), e.extend(i, {width: i.innerWidth - s, height: i.innerHeight - r}), i
            },
        ...
        return e.extend(i.prototype, {
            init: function () {
                ...
                var t, i;
                "mouse" === e.pointerType && e.button > 1 || (e.preventDefault(), this.handleDragActive || (this.slider.is(e.currentTarget) ? (t = this.handle.offset()[this.offsetProperty] > e[this.offsetEventProperty] ? -1 : 1, i = e[this.offsetEventProperty] - this.slider.offset()[this.offsetProperty], this.startPageScrolling(t, i)) : (t = this.btnDec.is(e.currentTarget) ? -1 : 1, this.startSmoothScrolling(t)), this.doc.on("jcf-pointerup", this.onButtonRelease)))
                ...
                var i = this, n = e * i.currentSize, o = function () {
                    var n = i.value / i.maxValue * (i.currentSliderSize - i.handleSize);
                    return e > 0 ? n + i.handleSize >= t : t >= n
                }, s = function () {
                    i.value += n, i.setValue(i.value), i.triggerScrollEvent(i.value), o() && clearInterval(i.pageScrollTimer)
                };
                this.pageScrollTimer = setInterval(s, this.options.scrollInterval), s()
            }, stopPageScrolling: function () {
                clearInterval(this.pageScrollTimer)
            }, startSmoothScrolling: function (e) {
                var i, n = this;
                this.stopSmoothScrolling();
                var o = t.requestAnimationFrame || function (e) {
                        setTimeout(e, 16)
                    }, s = function () {
                    return Date.now ? Date.now() : (new Date).getTime()
                }, r = function () {
                    return e > 0 ? n.value >= n.maxValue : n.value <= 0
                }, a = function () {
                    var t = (s() - i) / 1e3 * n.options.scrollStep;
                    n.smoothScrollActive && (n.value += t * e, n.setValue(n.value), n.triggerScrollEvent(n.value), r() || (i = s(), o(a)))
                };
                n.smoothScrollActive = !0, i = s(), o(a)
                ...
                var t = this.btnDec[this.fullSizeProperty](), i = this.btnInc[this.fullSizeProperty]();
    ...
    e.addModule(function (e) {
        ...
        return {
            ...
            getLabelFor: function () {
                var t = this.realElement.closest("label"), i = this.realElement.prop("id");
    ...
    e.addModule(function (t, i) {
        ...
        var r = {
            ...
            plugins: {ListBox: o, ComboBox: n, SelectList: s},
            matchElement: function (e) {
                return e.is("select")
            },
            init: function () {
            ...
            createInstance: function () {
                this.instance && this.instance.destroy(), this.instance = this.isListBox() && !this.options.multipleCompactStyle ? new o(this.options) : new n(this.options)
            },
            refresh: function () {
                var e = this.isListBox() && this.instance instanceof n || !this.isListBox() && this.instance instanceof o;
        ...
        t.extend(n.prototype, {
            init: function () {
                ...
                var e, t, i, n = this.fakeElement.offset(), o = this.fakeElement[0].getBoundingClientRect(), s = o.width || o.right - o.left, r = this.fakeElement.outerHeight(), a = this.dropdown.css("width", s).outerHeight(), l = this.win.scrollTop(), u = this.win.height(), d = !1;
                n.top + r + a > l + u && n.top - a > l && (d = !0), this.options.fakeDropInBody && (i = "static" !== this.fakeDropTarget.css("position") ? this.fakeDropTarget.offset().top : 0, this.options.flipDropToFit && d ? (t = n.left, e = n.top - a - i) : (t = n.left, e = n.top + r - i), this.dropdown.css({
                    width: s,
                    left: t,
                    top: e
                ...
                var e, i = this.realElement.prop("selectedIndex"), n = this.realElement.prop("options")[i], o = n ? n.getAttribute("data-image") : null, s = "", r = this;
                this.realElement.prop("multiple") ? (t.each(this.realElement.prop("options"), function (e, t) {
                    t.selected && (s += (s ? ", " : "") + t.innerHTML)
                }), s || (s = r.realElement.attr("placeholder") || ""), this.selectText.removeAttr("class").html(s)) : n ? this.currentSelectedText === n.innerHTML && this.currentSelectedImage === o || (e = a(n.className, this.options.optionClassPrefix), this.selectText.attr("class", e).html(n.innerHTML), o ? (this.selectImage || (this.selectImage = t("<img>").prependTo(this.selectTextContainer).hide()), this.selectImage.attr("src", o).show()) : this.selectImage && this.selectImage.hide(), this.currentSelectedText = n.innerHTML, this.currentSelectedImage = o) : (this.selectImage && this.selectImage.hide(), this.selectText.removeAttr("class").empty())
            }, refresh: function () {
            ...
            init: function () {
                ...
                this.realElement = t(this.options.element), this.fakeElement = t(this.options.fakeStructure).insertAfter(this.realElement), this.listHolder = this.fakeElement.find(this.options.listHolder), l(this.fakeElement), this.fakeElement.addClass(a(this.realElement.prop("className"), this.options.selectClassPrefix)), this.realElement.addClass(this.options.hiddenClass), this.list = new s({
                    useCustomScroll: this.options.useCustomScroll,
            ...
            init: function () {
                ...
                var i, n = parseFloat(e.currentTarget.getAttribute(this.options.indexAttribute)), o = e.data && e.data.savedPointerType || e.pointerType || "mouse";
                this.listHolder.off("click", this.indexSelector, this.onSelectItem), e.button > 1 || this.realOptions[n].disabled || (this.element.prop("multiple") ? e.metaKey || e.ctrlKey || "touch" === o || this.options.multipleSelectWithoutKey ? this.realOptions[n].selected = !this.realOptions[n].selected : e.shiftKey ? (i = [this.lastClickedIndex, n].sort(function (e, t) {
                    return e - t
                }), this.realOptions.each(function (e, t) {
                    t.selected = e >= i[0] && e <= i[1]
                })) : this.element.prop("selectedIndex", n) : this.element.prop("selectedIndex", n), e.shiftKey || (this.lastClickedIndex = n), this.refreshSelectedClass(), "mouse" === o && this.scrollToActiveOption(), t(this).trigger("select"))
            }, rebuildList: function () {
                var i = this, n = this.element[0];
                ...
                var o = this.options.maxVisibleItems, s = this.element.prop("size");
                s > 1 && !this.element.is("[jcf-size]") && (o = s);
                var r = this.fakeOptions.length > o;
                return this.container.toggleClass(this.options.scrollClass, r), r && (this.listHolder.css({
                    ...
                    var t = i.listHolder.scrollTop(), n = i.listHolder.prop("scrollHeight") - i.listHolder.innerHeight();
                    (0 >= t && e.deltaY < 0 || t >= n && e.deltaY > 0) && e.preventDefault()
                }, this.listHolder.on("jcf-mousewheel", this.preventWheelHandler)))
            }, refreshSelectedClass: function () {
                var e, t = this, i = this.element.prop("multiple"), n = this.element.prop("selectedIndex");
                ...
                var e = this.element.prop("selectedIndex"), i = this, n = !1, o = null;
                return this.element.prop("multiple") ? (this.currentSelection = this.getSelectedOptionsIndexes(), t.each(this.currentSelection, function (e, t) {
                    !n && i.previousSelection.indexOf(t) < 0 && (0 === e && (n = !0), o = t)
                }), this.previousSelection = this.currentSelection, o) : e
            }, getActiveOptionOffset: function () {
                var e = this.getChangedSelectedIndex();
                if (null !== e) {
                    var t = this.listHolder.height(), i = this.listHolder.prop("scrollTop"), n = this.fakeOptions.eq(e), o = n.offset().top - this.list.offset().top, s = n.innerHeight();
                    return o + s >= i + t ? o - t + s : i > o ? o : void 0
                }
            }, getOverflowHeight: function (e) {
                var t = this.fakeListItems.eq(e - 1), i = this.list.offset().top, n = t.offset().top, o = t.innerHeight();
                return n + o - i
                ...
                return n && (i = document.createElement("img"), i.src = n, t.insertBefore(i, t.childNodes[0])), e.disabled && (t.className += " " + this.options.disabledClass), e.className && (t.className += " " + a(e.className, this.options.cloneClassPrefix)), t
            }, createOptGroup: function (e) {
                var t, i, n = document.createElement("span"), o = e.getAttribute("label");
                return t = document.createElement("span"), t.className = this.options.captionClass, t.innerHTML = o, n.appendChild(t), e.children.length && (i = this.createOptionsList(e), n.appendChild(i)), n.className = this.options.groupClass, n
                ...
                return t.each(e.children, function (e, t) {
                    var o, s = i.createOptionContainer(t);
                    switch (t.tagName.toLowerCase()) {
                        case"option":
                            o = i.createOption(t);
                            break;
                        case"optgroup":
                            o = i.createOptGroup(t)
                    }
                    n.appendChild(s).appendChild(o)
                }), n
            }, refresh: function () {
    ...
    e.addModule(function (t) {
        ...
        return {
            ...
            getRadioGroup: function (e) {
                var i = e.attr("name"), n = e.parents("form");
                return i ? n.length ? n.find('input[name="' + i + '"]') : t('input[name="' + i + '"]:not(form input)') : e
            },
            getLabelFor: function () {
    ...
    var t, i, n, o, s, r, a = "Close", l = "BeforeClose", u = "AfterClose", d = "BeforeAppend", c = "MarkupParse", h = "Open", f = "Change", p = "mfp", m = "." + p, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close", b = function () {
    }, w = !!window.jQuery, x = e(window), S = function (e, i) {
        t.ev.on(p + e + m, i)
    }, k = function (t, i, n, o) {
    ...
    b.prototype = {
        constructor: b, init: function () {
            ...
            t.types = [], s = "", t.ev = i.mainEl && i.mainEl.length ? i.mainEl.eq(0) : n, i.key ? (t.popupsCache[i.key] || (t.popupsCache[i.key] = {}), t.currTemplate = t.popupsCache[i.key]) : t.currTemplate = {}, t.st = e.extend(!0, {}, e.magnificPopup.defaults, i), t.fixedContentPos = "auto" === t.st.fixedContentPos ? !t.probablyMobile : t.st.fixedContentPos, t.st.modal && (t.st.closeOnContentClick = !1, t.st.closeOnBgClick = !1, t.st.showCloseBtn = !1, t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = k("bg").on("click" + m, function () {
                t.close()
            ...
            T("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (S(c, function (e, t, i, n) {
                i.close_replaceWith = C(n.type)
            }), s += " mfp-close-btn-in") : t.wrap.append(C())), t.st.alignTop && (s += " mfp-align-top"), t.wrap.css(t.fixedContentPos ? {
            ...
            if (T("BeforeChange", [t.currItem ? t.currItem.type : "", n]), t.currItem = i, !t.currTemplate[n]) {
                ...
                T("FirstMarkupParse", s), t.currTemplate[n] = s ? e(s) : !0
            }
            o && o !== i.type && t.container.removeClass("mfp-" + o + "-holder");
            var r = t["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, t.currTemplate[n]);
            t.appendContent(r, n), i.preloaded = !0, T(f, i), o = i.type, t.container.prepend(t.contentContainer), T("AfterChange")
        }, appendContent: function (e, i) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[i] === !0 ? t.content.find(".mfp-close").length || t.content.append(C()) : t.content = e : t.content = "", T(d), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
        }, parseEl: function (i) {
            var n, o = t.items[i];
        ...
        modules: [],
        open: function (t, i) {
            return D(), t = t ? e.extend(!0, {}, t) : {}, t.isObj = !0, t.index = i || 0, this.instance.open(t)
        },
        close: function () {
            ...
            initInline: function () {
                ...
                if (F(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (O || (I = o.hiddenClass, O = k(I), I = "mfp-" + I), A = s.after(O).detach().removeClass(I)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(P, {
        options: {
            ...
            initAjax: function () {
                t.types.push(P), _ = t.st.ajax.cursor, S(a + "." + P, j), S("BeforeChange." + P, j)
            }, getAjax: function (i) {
                _ && e(document.body).addClass(_), t.updateStatus("loading");
                var n = e.extend({
                    url: i.src, success: function (n, o, s) {
                        var r = {data: n, xhr: s};
                        T("ParseAjax", r), t.appendContent(e(r.data), P), i.finished = !0, z(), t._setFocus(), setTimeout(function () {
                            t.wrap.addClass(g)
    ...
    e.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                t.types.push("image"), S(h + n, function () {
                ...
                }, i), t.resizeImage(), i.hasSize ? (W && clearInterval(W), i.loadError ? (n.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), t.updateStatus("ready")), n) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, n.addClass("mfp-loading"), t.findImageSize(i)), n)
            }
        }
    });
    var R, N = function () {
    ...
    var H = "iframe", $ = "//about:blank", B = function (e) {
        if (t.currTemplate[H]) {
            var i = t.currTemplate[H].find("iframe");
            i.length && (e || (i[0].src = $), t.isIE8 && i.css("display", e ? "block" : "none"))
        }
    };
    e.magnificPopup.registerModule(H, {
        options: {
            ...
            initIframe: function () {
                t.types.push(H), S("BeforeChange", function (e, t, i) {
                    t !== i && (t === H ? B() : i === H && B(!0))
                }), S(a + "." + H, function () {
                    B()
                })
    ...
    e.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                return t.direction = !0, i && i.enabled ? (s += " mfp-gallery", S(h + o, function () {
                ...
                }), S(c + o, function (e, n, o, s) {
                    var r = t.items.length;
                    o.counter = r > 1 ? q(i.tCounter, s.index, r) : ""
                }), S("BuildControls" + o, function () {
                    if (t.items.length > 1 && i.arrows && !t.arrowLeft) {
                        var n = i.arrowMarkup, o = t.arrowLeft = e(n.replace(/%title%/gi, i.tPrev).replace(/%dir%/gi, "left")).addClass(y), s = t.arrowRight = e(n.replace(/%title%/gi, i.tNext).replace(/%dir%/gi, "right")).addClass(y);
                        o.click(function () {
                            t.prev()
                        }), s.click(function () {
                            t.next()
...
!function () {
    ...
    o = 864e5, s = 3600, e = function (e, t) {
        ...
        constructor: DateFormatter, parseDate: function (t, i) {
            var n, o, s, r, a, l, u, d, c, h, f = this, p = !1, m = !1, g = f.dateSettings, v = {
                date: null,
                year: null,
                month: null,
                day: null,
            ...
            if ("U" === i)return s = parseInt(t), s ? new Date(1e3 * s) : t;
            if ("string" != typeof t)return "";
            if (n = i.match(f.validParts), !n || 0 === n.length)throw new Error("Invalid date format definition.");
            for (o = t.replace(f.separators, "\x00").split("\x00"), s = 0; s < o.length; s++)switch (r = o[s], a = parseInt(r), n[s]) {
                case"y":
                case"Y":
                    c = r.length, 2 === c ? v.year = parseInt((70 > a ? "20" : "19") + r) : 4 === c && (v.year = a), p = !0;
                    break;
                case"m":
                case"n":
                case"M":
                case"F":
                    isNaN(r) ? (l = g.monthsShort.indexOf(r), l > -1 && (v.month = l + 1), l = g.months.indexOf(r), l > -1 && (v.month = l + 1)) : a >= 1 && 12 >= a && (v.month = a), p = !0;
                    break;
                case"d":
                case"j":
                    a >= 1 && 31 >= a && (v.day = a), p = !0;
                    break;
                case"g":
                case"h":
                    u = n.indexOf("a") > -1 ? n.indexOf("a") : n.indexOf("A") > -1 ? n.indexOf("A") : -1, h = o[u], u > -1 ? (d = e(h, g.meridiem[0]) ? 0 : e(h, g.meridiem[1]) ? 12 : -1, a >= 1 && 12 >= a && d > -1 ? v.hour = a + d : a >= 0 && 23 >= a && (v.hour = a)) : a >= 0 && 23 >= a && (v.hour = a), m = !0;
                    break;
                case"G":
                case"H":
                    a >= 0 && 23 >= a && (v.hour = a), m = !0;
                    break;
                case"i":
                    a >= 0 && 59 >= a && (v.min = a), m = !0;
                    break;
                case"s":
                    a >= 0 && 59 >= a && (v.sec = a), m = !0
            }
            if (p === !0 && v.year && v.month && v.day)v.date = new Date(v.year, v.month - 1, v.day, v.hour, v.min, v.sec, 0); else {
                if (m !== !0)return !1;
            ...
            var i, n, o, s, r = this, a = e.replace(r.separators, "\x00").split("\x00"), l = /^[djmn]/g, u = t.match(r.validParts), d = new Date, c = 0;
            if (!l.test(u[0]))return e;
            for (n = 0; n < a.length; n++) {
                switch (c = 2, o = a[n], s = parseInt(o.substr(0, 2)), n) {
                    case 0:
                        "m" === u[0] || "n" === u[0] ? d.setMonth(s - 1) : d.setDate(s);
                        break;
                    case 1:
                        "m" === u[0] || "n" === u[0] ? d.setDate(s) : d.setMonth(s - 1);
                        break;
                    case 2:
                        i = d.getFullYear(), o.length < 4 ? (d.setFullYear(parseInt(i.toString().substr(0, 4 - o.length) + o)), c = o.length) : (d.setFullYear = parseInt(o.substr(0, 4)), c = 4);
                        break;
                    case 3:
                        d.setHours(s);
                        break;
                ...
                o.substr(c).length > 0 && a.splice(n + 1, 0, o.substr(c))
            }
            return d
        }, parseFormat: function (e, i) {
            var n, r = this, a = r.dateSettings, l = /\\?(.?)/gi, u = function (e, t) {
                return n[e] ? n[e]() : t
            };
            return n = {
                d: function () {
                    ...
                    var e = n.n(), t = n.W(), i = n.Y();
                    return i + (12 === e && 9 > t ? 1 : 1 === e && t > 9 ? -1 : 0)
                }, Y: function () {
                    ...
                    var e = i.getUTCHours() * s, n = 60 * i.getUTCMinutes(), o = i.getUTCSeconds();
                    return t(Math.floor((e + n + o + s) / 86.4) % 1e3, 3)
                }, g: function () {
                    return n.G() % 12 || 12
                }, G: function () {
                    return i.getHours()
                    ...
                    var e = /\((.*)\)/.exec(String(i))[1];
                    return e || "Coordinated Universal Time"
                }, T: function () {
                    var e = (String(i).match(r.tzParts) || [""]).pop().replace(r.tzClip, "");
                    return e || "UTC"
                }, I: function () {
                    var e = new Date(n.Y(), 0), t = Date.UTC(n.Y(), 0), i = new Date(n.Y(), 6), o = Date.UTC(n.Y(), 6);
                    return e - t !== i - o ? 1 : 0
                }, O: function () {
            ...
            if ("string" == typeof e && (e = a.parseDate(e, t), e === !1))return !1;
            if (e instanceof Date) {
                for (o = t.length, i = 0; o > i; i++)r = t.charAt(i), "S" !== r && (s = a.parseFormat(r, e), i !== o - 1 && a.intParts.test(r) && "S" === t.charAt(i + 1) && (n = parseInt(s), s += a.dateSettings.ordinal(n)), l += s);
                return l
            }
            return ""
        }
    ...
    var i = !1, n = {
        ...
        enterLikeTab: !0,
        showApplyButton: !1
    }, o = null, s = "en", r = "en", a = {meridiem: ["AM", "PM"]}, l = function () {
        var t = n.i18n[r], i = {
            days: t.dayOfWeek,
        ...
        o = new DateFormatter({dateSettings: e.extend({}, a, i)})
    };
    e.datetimepicker = {
        ...
        RSS: "D, d M Y H:i:s O",
        W3C: "Y-m-dTH:i:sP"
    }, l(), window.getComputedStyle || (window.getComputedStyle = function (e) {
        ...
        return this.each(function () {
            var i, n, o, s, r, a = e(this), l = function (e) {
                var t, i = {x: 0, y: 0};
            ...
            }, u = 100, d = !1, c = 0, h = 0, f = 0, p = !1, m = 0, g = function () {
            };
            return "hide" === t ? void a.find(".xdsoft_scrollbar").hide() : (e(this).hasClass("xdsoft_scroller_box") || (i = a.children().eq(0), n = a[0].clientHeight, o = i[0].offsetHeight, s = e('<div class="xdsoft_scrollbar"></div>'), r = e('<div class="xdsoft_scroller"></div>'), s.append(r), a.addClass("xdsoft_scroller_box").append(s), g = function (e) {
                var t = l(e).y - c + m;
                0 > t && (t = 0), t + r[0].offsetHeight > f && (t = f - r[0].offsetHeight), a.trigger("scroll_element.xdsoft_scroller", [u ? t / u : 0])
            }, r.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", function (i) {
                n || a.trigger("resize_scroll.xdsoft_scroller", [t]), c = l(i).y, m = parseInt(r.css("margin-top"), 10), f = s[0].offsetHeight, "mousedown" === i.type || "touchstart" === i.type ? (document && e(document.body).addClass("xdsoft_noselect"), e([document.body, window]).on("touchend mouseup.xdsoft_scroller", function o() {
                    e([document.body, window]).off("touchend mouseup.xdsoft_scroller", o).off("mousemove.xdsoft_scroller", g).removeClass("xdsoft_noselect")
                }), e(document.body).on("mousemove.xdsoft_scroller", g)) : (p = !0, i.stopPropagation(), i.preventDefault())
            }).on("touchmove", function (e) {
                p && (e.preventDefault(), g(e))
            }).on("touchend touchcancel", function () {
                p = !1, m = 0
            }), a.on("scroll_element.xdsoft_scroller", function (e, t) {
                n || a.trigger("resize_scroll.xdsoft_scroller", [t, !0]), t = t > 1 ? 1 : 0 > t || isNaN(t) ? 0 : t, r.css("margin-top", u * t), setTimeout(function () {
                    i.css("marginTop", -parseInt((i[0].offsetHeight - n) * t, 10))
                }, 10)
            }).on("resize_scroll.xdsoft_scroller", function (e, t, l) {
                var d, c;
                n = a[0].clientHeight, o = i[0].offsetHeight, d = n / o, c = d * s[0].offsetHeight, d > 1 ? r.hide() : (r.show(), r.css("height", parseInt(c > 10 ? c : 10, 10)), u = s[0].offsetHeight - r[0].offsetHeight, l !== !0 && a.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(i.css("marginTop"), 10)) / (o - n)]))
            }), a.on("mousewheel", function (e) {
                var t = Math.abs(parseInt(i.css("marginTop"), 10));
                return t -= 20 * e.deltaY, 0 > t && (t = 0), a.trigger("scroll_element.xdsoft_scroller", [t / (o - n)]), e.stopPropagation(), !1
            }), a.on("touchstart", function (e) {
                d = l(e), h = Math.abs(parseInt(i.css("marginTop"), 10))
            }), a.on("touchmove", function (e) {
                if (d) {
                    e.preventDefault();
                    var t = l(e);
                    a.trigger("scroll_element.xdsoft_scroller", [(h - (t.y - d.y)) / (o - n)])
                }
            }), a.on("touchend touchcancel", function () {
                d = !1, h = 0
            })), void a.trigger("resize_scroll.xdsoft_scroller", [t]))
        })
    }, e.fn.datetimepicker = function (s, a) {
        var l, u, d = this, c = 48, h = 57, f = 96, p = 105, m = 17, g = 46, v = 13, y = 27, b = 8, w = 37, x = 38, S = 39, k = 40, T = 9, C = 116, D = 65, E = 67, I = 86, O = 90, A = 89, M = !1, F = e.isPlainObject(s) || !s ? e.extend(!0, {}, n, s) : e.extend(!0, {}, n), _ = 0, P = function (e) {
            e.on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function t() {
                e.is(":disabled") || e.data("xdsoft_datetimepicker") || (clearTimeout(_), _ = setTimeout(function () {
                    e.data("xdsoft_datetimepicker") || l(e), e.off("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", t).trigger("open.xdsoft")
                }, 100))
            })
        };
        return l = function (n) {
            function a() {
                var e, t = !1;
                return F.startDate ? t = j.strToDate(F.startDate) : (t = F.value || (n && n.val && n.val() ? n.val() : ""), t ? t = j.strToDateTime(t) : F.defaultDate && (t = j.strToDateTime(F.defaultDate), F.defaultTime && (e = j.strtotime(F.defaultTime), t.setHours(e.getHours()), t.setMinutes(e.getMinutes())))), t && j.isValidDate(t) ? L.data("changed", !0) : t = "", t || 0
            }
            ...
            function l(t) {
                ...
                t.mask && n.off("keydown.xdsoft"), t.mask === !0 && (t.mask = "undefined" != typeof moment ? t.format.replace(/Y{4}/g, "9999").replace(/Y{2}/g, "99").replace(/M{2}/g, "19").replace(/D{2}/g, "39").replace(/H{2}/g, "29").replace(/m{2}/g, "59").replace(/s{2}/g, "59") : t.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(t.mask) && (i(t.mask, n.val()) || (n.val(t.mask.replace(/[0-9]/g, "_")), s(n[0], 0)), n.on("keydown.xdsoft", function (r) {
                    var a, l, u = this.value, d = r.which;
                    if (d >= c && h >= d || d >= f && p >= d || d === b || d === g) {
                        for (a = o(this), l = d !== b && d !== g ? String.fromCharCode(d >= f && p >= d ? d - c : d) : "_", d !== b && d !== g || !a || (a -= 1, l = "_"); /[^0-9_]/.test(t.mask.substr(a, 1)) && a < t.mask.length && a > 0;)a += d === b || d === g ? -1 : 1;
                        if (u = u.substr(0, a) + l + u.substr(a + 1), "" === e.trim(u))u = t.mask.replace(/[0-9]/g, "_"); else if (a === t.mask.length)return r.preventDefault(), !1;
                        for (a += d === b || d === g ? 0 : 1; /[^0-9_]/.test(t.mask.substr(a, 1)) && a < t.mask.length && a > 0;)a += d === b || d === g ? -1 : 1;
                        i(t.mask, u) ? (this.value = u, s(this, a)) : "" === e.trim(u) ? this.value = t.mask.replace(/[0-9]/g, "_") : n.trigger("error_input.xdsoft")
                    } else if (-1 !== [D, E, I, O, A].indexOf(d) && M || -1 !== [y, x, k, w, S, C, m, T, v].indexOf(d))return !0;
                    return r.preventDefault(), !1
                }))
            }

            var u, d, _, P, z, j, W, L = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'), R = e('<div class="xdsoft_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'), N = e('<div class="xdsoft_datepicker active"></div>'), H = e('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'), $ = e('<div class="xdsoft_calendar"></div>'), B = e('<div class="xdsoft_timepicker active"><button type="button" class="xdsoft_prev"></button><div class="xdsoft_time_box"></div><button type="button" class="xdsoft_next"></button></div>'), Y = B.find(".xdsoft_time_box").eq(0), q = e('<div class="xdsoft_time_variant"></div>'), V = e('<button type="button" class="xdsoft_save_selected blue-gradient-button">Save Selected</button>'), U = e('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'), J = e('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'), X = !1, G = 0;
            F.id && L.attr("id", F.id), F.style && L.attr("style", F.style), F.weeks && L.addClass("xdsoft_showweeks"), F.rtl && L.addClass("xdsoft_rtl"), L.addClass("xdsoft_" + F.theme), L.addClass(F.className), H.find(".xdsoft_month span").after(U), H.find(".xdsoft_year span").after(J), H.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                var i, n, o = e(this).find(".xdsoft_select").eq(0), s = 0, r = 0, a = o.is(":visible");
                for (H.find(".xdsoft_select").hide(), j.currentTime && (s = j.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), o[a ? "hide" : "show"](), i = o.find("div.xdsoft_option"), n = 0; n < i.length && i.eq(n).data("value") !== s; n += 1)r += i[0].offsetHeight;
                return o.xdsoftScroller(r / (o.children()[0].offsetHeight - o[0].clientHeight)), t.stopPropagation(), !1
            }), H.find(".xdsoft_select").xdsoftScroller().on("touchstart mousedown.xdsoft", function (e) {
                e.stopPropagation(), e.preventDefault()
            }).on("touchstart mousedown.xdsoft", ".xdsoft_option", function () {
                (void 0 === j.currentTime || null === j.currentTime) && (j.currentTime = j.now());
                var t = j.currentTime.getFullYear();
                j && j.currentTime && j.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")), e(this).parent().parent().hide(), L.trigger("xchange.xdsoft"), F.onChangeMonth && e.isFunction(F.onChangeMonth) && F.onChangeMonth.call(L, j.currentTime, L.data("input")), t !== j.currentTime.getFullYear() && e.isFunction(F.onChangeYear) && F.onChangeYear.call(L, j.currentTime, L.data("input"))
            }), L.getValue = function () {
                return j.getCurrentTime()
            }, L.setOptions = function (i) {
                var s = {};
                F = e.extend(!0, {}, F, i), i.allowTimes && e.isArray(i.allowTimes) && i.allowTimes.length && (F.allowTimes = e.extend(!0, [], i.allowTimes)), i.weekends && e.isArray(i.weekends) && i.weekends.length && (F.weekends = e.extend(!0, [], i.weekends)), i.allowDates && e.isArray(i.allowDates) && i.allowDates.length && (F.allowDates = e.extend(!0, [], i.allowDates)), i.allowDateRe && "[object String]" === Object.prototype.toString.call(i.allowDateRe) && (F.allowDateRe = new RegExp(i.allowDateRe)), i.highlightedDates && e.isArray(i.highlightedDates) && i.highlightedDates.length && (e.each(i.highlightedDates, function (i, n) {
                    var r, a = e.map(n.split(","), e.trim), l = new t(o.parseDate(a[0], F.formatDate), a[1], a[2]), u = o.formatDate(l.date, F.formatDate);
                    void 0 !== s[u] ? (r = s[u].desc, r && r.length && l.desc && l.desc.length && (s[u].desc = r + "\n" + l.desc)) : s[u] = l
                }), F.highlightedDates = e.extend(!0, [], s)), i.highlightedPeriods && e.isArray(i.highlightedPeriods) && i.highlightedPeriods.length && (s = e.extend(!0, [], F.highlightedDates), e.each(i.highlightedPeriods, function (i, n) {
                    var r, a, l, u, d, c, h;
                    if (e.isArray(n))r = n[0], a = n[1], l = n[2], h = n[3]; else {
                        var f = e.map(n.split(","), e.trim);
                        r = o.parseDate(f[0], F.formatDate), a = o.parseDate(f[1], F.formatDate), l = f[2], h = f[3]
                    }
                    for (; a >= r;)u = new t(r, l, h), d = o.formatDate(r, F.formatDate), r.setDate(r.getDate() + 1), void 0 !== s[d] ? (c = s[d].desc, c && c.length && u.desc && u.desc.length && (s[d].desc = c + "\n" + u.desc)) : s[d] = u
                }), F.highlightedDates = e.extend(!0, [], s)), i.disabledDates && e.isArray(i.disabledDates) && i.disabledDates.length && (F.disabledDates = e.extend(!0, [], i.disabledDates)), i.disabledWeekDays && e.isArray(i.disabledWeekDays) && i.disabledWeekDays.length && (F.disabledWeekDays = e.extend(!0, [], i.disabledWeekDays)), !F.open && !F.opened || F.inline || n.trigger("open.xdsoft"), F.inline && (X = !0, L.addClass("xdsoft_inline"), n.after(L).hide()), F.inverseButton && (F.next = "xdsoft_prev", F.prev = "xdsoft_next"), F.datepicker ? N.addClass("active") : N.removeClass("active"), F.timepicker ? B.addClass("active") : B.removeClass("active"), F.value && (j.setCurrentTime(F.value), n && n.val && n.val(j.str)), F.dayOfWeekStart = isNaN(F.dayOfWeekStart) ? 0 : parseInt(F.dayOfWeekStart, 10) % 7, F.timepickerScrollbar || Y.xdsoftScroller("hide"), F.minDate && /^[\+\-](.*)$/.test(F.minDate) && (F.minDate = o.formatDate(j.strToDateTime(F.minDate), F.formatDate)), F.maxDate && /^[\+\-](.*)$/.test(F.maxDate) && (F.maxDate = o.formatDate(j.strToDateTime(F.maxDate), F.formatDate)), V.toggle(F.showApplyButton), H.find(".xdsoft_today_button").css("visibility", F.todayButton ? "visible" : "hidden"), H.find("." + F.prev).css("visibility", F.prevButton ? "visible" : "hidden"), H.find("." + F.next).css("visibility", F.nextButton ? "visible" : "hidden"), l(F), F.validateOnBlur && n.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (F.allowBlank && (!e.trim(e(this).val()).length || "string" == typeof F.mask && e.trim(e(this).val()) === F.mask.replace(/[0-9]/g, "_")))e(this).val(null), L.data("xdsoft_datetime").empty(); else {
                        var t = o.parseDate(e(this).val(), F.format);
                        if (t)e(this).val(o.formatDate(t, F.format)); else {
                            var i = +[e(this).val()[0], e(this).val()[1]].join(""), n = +[e(this).val()[2], e(this).val()[3]].join("");
                            e(this).val(!F.datepicker && F.timepicker && i >= 0 && 24 > i && n >= 0 && 60 > n ? [i, n].map(function (e) {
                                return e > 9 ? e : "0" + e
                            }).join(":") : o.formatDate(j.now(), F.format))
                        }
                        L.data("xdsoft_datetime").setCurrentTime(e(this).val())
                    }
                    L.trigger("changedatetime.xdsoft"), L.trigger("close.xdsoft")
                }), F.dayOfWeekStartPrev = 0 === F.dayOfWeekStart ? 6 : F.dayOfWeekStart - 1, L.trigger("xchange.xdsoft").trigger("afterOpen.xdsoft")
            }, L.data("options", F).on("touchstart mousedown.xdsoft", function (e) {
                return e.stopPropagation(), e.preventDefault(), J.hide(), U.hide(), !1
            }), Y.append(q), Y.xdsoftScroller(), L.on("afterOpen.xdsoft", function () {
                Y.xdsoftScroller()
            }), L.append(N).append(B), F.withoutCopyright !== !0 && L.append(R), N.append(H).append($).append(V), e(F.parentID).append(L), u = function () {
                var t = this;
                t.now = function (e) {
                    var i, n, o = new Date;
                    return !e && F.defaultDate && (i = t.strToDateTime(F.defaultDate), o.setFullYear(i.getFullYear()), o.setMonth(i.getMonth()), o.setDate(i.getDate())), F.yearOffset && o.setFullYear(o.getFullYear() + F.yearOffset), !e && F.defaultTime && (n = t.strtotime(F.defaultTime), o.setHours(n.getHours()), o.setMinutes(n.getMinutes())), o
                }, t.isValidDate = function (e) {
                    return "[object Date]" !== Object.prototype.toString.call(e) ? !1 : !isNaN(e.getTime())
                }, t.setCurrentTime = function (e, i) {
                    t.currentTime = "string" == typeof e ? t.strToDateTime(e) : t.isValidDate(e) ? e : e || i || !F.allowBlank ? t.now() : null, L.trigger("xchange.xdsoft")
                }, t.empty = function () {
                    t.currentTime = null
                    ...
                    return 12 === n && (t.currentTime.setFullYear(t.currentTime.getFullYear() + 1), n = 0), i = t.currentTime.getFullYear(), t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), n + 1, 0).getDate(), t.currentTime.getDate())), t.currentTime.setMonth(n), F.onChangeMonth && e.isFunction(F.onChangeMonth) && F.onChangeMonth.call(L, j.currentTime, L.data("input")), i !== t.currentTime.getFullYear() && e.isFunction(F.onChangeYear) && F.onChangeYear.call(L, j.currentTime, L.data("input")), L.trigger("xchange.xdsoft"), n
                }, t.prevMonth = function () {
                    (void 0 === t.currentTime || null === t.currentTime) && (t.currentTime = t.now());
                    var i = t.currentTime.getMonth() - 1;
                    return -1 === i && (t.currentTime.setFullYear(t.currentTime.getFullYear() - 1), i = 11), t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), i + 1, 0).getDate(), t.currentTime.getDate())), t.currentTime.setMonth(i), F.onChangeMonth && e.isFunction(F.onChangeMonth) && F.onChangeMonth.call(L, j.currentTime, L.data("input")), L.trigger("xchange.xdsoft"), i
                }, t.getWeekOfYear = function (t) {
                    if (F.onGetWeekOfYear && e.isFunction(F.onGetWeekOfYear)) {
                        var i = F.onGetWeekOfYear.call(L, t);
                    ...
                    var i, n, s = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : (s = /^(\+|\-)(.*)$/.exec(e), s && (s[2] = o.parseDate(s[2], F.formatDate)), s && s[2] ? (i = s[2].getTime() - 6e4 * s[2].getTimezoneOffset(), n = new Date(t.now(!0).getTime() + parseInt(s[1] + "1", 10) * i)) : n = e ? o.parseDate(e, F.format) : t.now(), t.isValidDate(n) || (n = t.now()), n)
                }, t.strToDate = function (e) {
                    if (e && e instanceof Date && t.isValidDate(e))return e;
                    var i = e ? o.parseDate(e, F.formatDate) : t.now(!0);
                    return t.isValidDate(i) || (i = t.now(!0)), i
                }, t.strtotime = function (e) {
                    if (e && e instanceof Date && t.isValidDate(e))return e;
                    var i = e ? o.parseDate(e, F.formatTime) : t.now(!0);
                    return t.isValidDate(i) || (i = t.now(!0)), i
                }, t.str = function () {
                    return o.formatDate(t.currentTime, F.format)
                }, t.currentTime = this.now()
            }, j = new u, V.on("touchend click", function (e) {
                e.preventDefault(), L.data("changed", !0), j.setCurrentTime(a()), n.val(j.str()), L.trigger("close.xdsoft")
            }), H.find(".xdsoft_today_button").on("touchend mousedown.xdsoft", function () {
                L.data("changed", !0), j.setCurrentTime(0, !0), L.trigger("afterOpen.xdsoft")
            }).on("dblclick.xdsoft", function () {
                var e, t, i = j.getCurrentTime();
                i = new Date(i.getFullYear(), i.getMonth(), i.getDate()), e = j.strToDate(F.minDate), e = new Date(e.getFullYear(), e.getMonth(), e.getDate()), e > i || (t = j.strToDate(F.maxDate), t = new Date(t.getFullYear(), t.getMonth(), t.getDate()), i > t || (n.val(j.str()), n.trigger("change"), L.trigger("close.xdsoft")))
            }), H.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                var t = e(this), i = 0, n = !1;
                !function o(e) {
                    t.hasClass(F.next) ? j.nextMonth() : t.hasClass(F.prev) && j.prevMonth(), F.monthChangeSpinner && (n || (i = setTimeout(o, e || 100)))
                }(500), e([document.body, window]).on("touchend mouseup.xdsoft", function s() {
                    clearTimeout(i), n = !0, e([document.body, window]).off("touchend mouseup.xdsoft", s)
                })
            }), B.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                var t = e(this), i = 0, n = !1, o = 110;
                !function s(e) {
                    var r = Y[0].clientHeight, a = q[0].offsetHeight, l = Math.abs(parseInt(q.css("marginTop"), 10));
                    t.hasClass(F.next) && a - r - F.timeHeightInTimePicker >= l ? q.css("marginTop", "-" + (l + F.timeHeightInTimePicker) + "px") : t.hasClass(F.prev) && l - F.timeHeightInTimePicker >= 0 && q.css("marginTop", "-" + (l - F.timeHeightInTimePicker) + "px"), Y.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(q[0].style.marginTop, 10) / (a - r))]), o = o > 10 ? 10 : o - 10, n || (i = setTimeout(s, e || o))
                }(500), e([document.body, window]).on("touchend mouseup.xdsoft", function r() {
                    clearTimeout(i), n = !0, e([document.body, window]).off("touchend mouseup.xdsoft", r)
                })
            }), d = 0, L.on("xchange.xdsoft", function (t) {
                clearTimeout(d), d = setTimeout(function () {
                    if (void 0 === j.currentTime || null === j.currentTime) {
                        if (F.allowBlank)return;
                        j.currentTime = j.now()
                    }
                    for (var t, i, a, l, u, d, c, h, f, p, m = "", g = new Date(j.currentTime.getFullYear(), j.currentTime.getMonth(), 1, 12, 0, 0), v = 0, y = j.now(), b = !1, w = !1, x = [], S = !0, k = "", T = ""; g.getDay() !== F.dayOfWeekStart;)g.setDate(g.getDate() - 1);
                    for (m += "<table><thead><tr>", F.weeks && (m += "<th></th>"), t = 0; 7 > t; t += 1)m += "<th>" + F.i18n[r].dayOfWeekShort[(t + F.dayOfWeekStart) % 7] + "</th>";
                    for (m += "</tr></thead>", m += "<tbody>", F.maxDate !== !1 && (b = j.strToDate(F.maxDate), b = new Date(b.getFullYear(), b.getMonth(), b.getDate(), 23, 59, 59, 999)), F.minDate !== !1 && (w = j.strToDate(F.minDate), w = new Date(w.getFullYear(), w.getMonth(), w.getDate())); v < j.currentTime.countDaysInMonth() || g.getDay() !== F.dayOfWeekStart || j.currentTime.getMonth() === g.getMonth();)x = [], v += 1, a = g.getDay(), l = g.getDate(), u = g.getFullYear(), d = g.getMonth(), c = j.getWeekOfYear(g), p = "", x.push("xdsoft_date"), h = F.beforeShowDay && e.isFunction(F.beforeShowDay.call) ? F.beforeShowDay.call(L, g) : null, F.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(F.allowDateRe) ? F.allowDateRe.test(o.formatDate(g, F.formatDate)) || x.push("xdsoft_disabled") : F.allowDates && F.allowDates.length > 0 ? -1 === F.allowDates.indexOf(o.formatDate(g, F.formatDate)) && x.push("xdsoft_disabled") : b !== !1 && g > b || w !== !1 && w > g || h && h[0] === !1 ? x.push("xdsoft_disabled") : -1 !== F.disabledDates.indexOf(o.formatDate(g, F.formatDate)) ? x.push("xdsoft_disabled") : -1 !== F.disabledWeekDays.indexOf(a) ? x.push("xdsoft_disabled") : n.is("[readonly]") && x.push("xdsoft_disabled"), h && "" !== h[1] && x.push(h[1]), j.currentTime.getMonth() !== d && x.push("xdsoft_other_month"), (F.defaultSelect || L.data("changed")) && o.formatDate(j.currentTime, F.formatDate) === o.formatDate(g, F.formatDate) && x.push("xdsoft_current"), o.formatDate(y, F.formatDate) === o.formatDate(g, F.formatDate) && x.push("xdsoft_today"), (0 === g.getDay() || 6 === g.getDay() || -1 !== F.weekends.indexOf(o.formatDate(g, F.formatDate))) && x.push("xdsoft_weekend"), void 0 !== F.highlightedDates[o.formatDate(g, F.formatDate)] && (i = F.highlightedDates[o.formatDate(g, F.formatDate)], x.push(void 0 === i.style ? "xdsoft_highlighted_default" : i.style), p = void 0 === i.desc ? "" : i.desc), F.beforeShowDay && e.isFunction(F.beforeShowDay) && x.push(F.beforeShowDay(g)), S && (m += "<tr>", S = !1, F.weeks && (m += "<th>" + c + "</th>")), m += '<td data-date="' + l + '" data-month="' + d + '" data-year="' + u + '" class="xdsoft_date xdsoft_day_of_week' + g.getDay() + " " + x.join(" ") + '" title="' + p + '"><div>' + l + "</div></td>", g.getDay() === F.dayOfWeekStartPrev && (m += "</tr>", S = !0), g.setDate(l + 1);
                    if (m += "</tbody></table>", $.html(m), H.find(".xdsoft_label span").eq(0).text(F.i18n[r].months[j.currentTime.getMonth()]), H.find(".xdsoft_label span").eq(1).text(j.currentTime.getFullYear()), k = "", T = "", d = "", f = function (t, i) {
                            var s, r, a = j.now(), l = F.allowTimes && e.isArray(F.allowTimes) && F.allowTimes.length;
                            a.setHours(t), t = parseInt(a.getHours(), 10), a.setMinutes(i), i = parseInt(a.getMinutes(), 10), s = new Date(j.currentTime), s.setHours(t), s.setMinutes(i), x = [], -1 !== F.disabledDates.indexOf(o.formatDate(s, F.formatDate)) && x.push("xdsoft_disabled"), F.minDateTime !== !1 && F.minDateTime > s || F.maxTime !== !1 && j.strtotime(F.maxTime).getTime() < a.getTime() || F.minTime !== !1 && j.strtotime(F.minTime).getTime() > a.getTime() ? x.push("xdsoft_disabled") : F.minDateTime !== !1 && F.minDateTime > s || F.disabledMinTime !== !1 && a.getTime() > j.strtotime(F.disabledMinTime).getTime() && F.disabledMaxTime !== !1 && a.getTime() < j.strtotime(F.disabledMaxTime).getTime() ? x.push("xdsoft_disabled") : n.is("[readonly]") && x.push("xdsoft_disabled"), r = new Date(j.currentTime), r.setHours(parseInt(j.currentTime.getHours(), 10)), l || r.setMinutes(Math[F.roundTime](j.currentTime.getMinutes() / F.step) * F.step), (F.initTime || F.defaultSelect || L.data("changed")) && r.getHours() === parseInt(t, 10) && (!l && F.step > 59 || r.getMinutes() === parseInt(i, 10)) && (F.defaultSelect || L.data("changed") ? x.push("xdsoft_current") : F.initTime && x.push("xdsoft_init_time")), parseInt(y.getHours(), 10) === parseInt(t, 10) && parseInt(y.getMinutes(), 10) === parseInt(i, 10) && x.push("xdsoft_today"), k += '<div class="xdsoft_time ' + x.join(" ") + '" data-hour="' + t + '" data-minute="' + i + '">' + o.formatDate(a, F.formatTime) + "</div>"
                        }, F.allowTimes && e.isArray(F.allowTimes) && F.allowTimes.length)for (v = 0; v < F.allowTimes.length; v += 1)T = j.strtotime(F.allowTimes[v]).getHours(), d = j.strtotime(F.allowTimes[v]).getMinutes(), f(T, d); else for (v = 0, t = 0; v < (F.hours12 ? 12 : 24); v += 1)for (t = 0; 60 > t; t += F.step)T = (10 > v ? "0" : "") + v, d = (10 > t ? "0" : "") + t, f(T, d);
                    for (q.html(k), s = "", v = 0, v = parseInt(F.yearStart, 10) + F.yearOffset; v <= parseInt(F.yearEnd, 10) + F.yearOffset; v += 1)s += '<div class="xdsoft_option ' + (j.currentTime.getFullYear() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + v + "</div>";
                    for (J.children().eq(0).html(s), v = parseInt(F.monthStart, 10), s = ""; v <= parseInt(F.monthEnd, 10); v += 1)s += '<div class="xdsoft_option ' + (j.currentTime.getMonth() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + F.i18n[r].months[v] + "</div>";
                    U.children().eq(0).html(s), e(L).trigger("generate.xdsoft")
                }, 10), t.stopPropagation()
            }).on("afterOpen.xdsoft", function () {
                if (F.timepicker) {
                    var e, t, i, n;
                    q.find(".xdsoft_current").length ? e = ".xdsoft_current" : q.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"), e ? (t = Y[0].clientHeight, i = q[0].offsetHeight, n = q.find(e).index() * F.timeHeightInTimePicker + 1, n > i - t && (n = i - t), Y.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : Y.trigger("scroll_element.xdsoft_scroller", [0])
                }
            }), _ = 0, $.on("touchend click.xdsoft", "td", function (t) {
                t.stopPropagation(), _ += 1;
                var i = e(this), o = j.currentTime;
                return (void 0 === o || null === o) && (j.currentTime = j.now(), o = j.currentTime), i.hasClass("xdsoft_disabled") ? !1 : (o.setDate(1), o.setFullYear(i.data("year")), o.setMonth(i.data("month")), o.setDate(i.data("date")), L.trigger("select.xdsoft", [o]), n.val(j.str()), F.onSelectDate && e.isFunction(F.onSelectDate) && F.onSelectDate.call(L, j.currentTime, L.data("input"), t), L.data("changed", !0), L.trigger("xchange.xdsoft"), L.trigger("changedatetime.xdsoft"), (_ > 1 || F.closeOnDateSelect === !0 || F.closeOnDateSelect === !1 && !F.timepicker) && !F.inline && L.trigger("close.xdsoft"), void setTimeout(function () {
                    _ = 0
                }, 200))
            }), q.on("touchmove", "div", function () {
                i = !0
            }).on("touchend click.xdsoft", "div", function (t) {
                if (t.stopPropagation(), i)return void(i = !1);
                var n = e(this), o = j.currentTime;
                return (void 0 === o || null === o) && (j.currentTime = j.now(), o = j.currentTime), n.hasClass("xdsoft_disabled") ? !1 : (o.setHours(n.data("hour")), o.setMinutes(n.data("minute")), L.trigger("select.xdsoft", [o]), L.data("input").val(j.str()), F.onSelectTime && e.isFunction(F.onSelectTime) && F.onSelectTime.call(L, j.currentTime, L.data("input"), t), L.data("changed", !0), L.trigger("xchange.xdsoft"), L.trigger("changedatetime.xdsoft"), void(F.inline !== !0 && F.closeOnTimeSelect === !0 && L.trigger("close.xdsoft")))
            }), N.on("mousewheel.xdsoft", function (e) {
                return F.scrollMonth ? (e.deltaY < 0 ? j.nextMonth() : j.prevMonth(), !1) : !0
            }), n.on("mousewheel.xdsoft", function (e) {
                return F.scrollInput ? !F.datepicker && F.timepicker ? (P = q.find(".xdsoft_current").length ? q.find(".xdsoft_current").eq(0).index() : 0, P + e.deltaY >= 0 && P + e.deltaY < q.children().length && (P += e.deltaY), q.children().eq(P).length && q.children().eq(P).trigger("mousedown"), !1) : F.datepicker && !F.timepicker ? (N.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), n.val && n.val(j.str()), L.trigger("changedatetime.xdsoft"), !1) : void 0 : !0
            }), L.on("changedatetime.xdsoft", function (t) {
                if (F.onChangeDateTime && e.isFunction(F.onChangeDateTime)) {
                    var i = L.data("input");
                    F.onChangeDateTime.call(L, j.currentTime, i, t), delete F.value, i.trigger("change")
                }
            }).on("generate.xdsoft", function () {
                F.onGenerate && e.isFunction(F.onGenerate) && F.onGenerate.call(L, j.currentTime, L.data("input")), X && (L.trigger("afterOpen.xdsoft"), X = !1)
            }).on("click.xdsoft", function (e) {
                e.stopPropagation()
            }), P = 0, W = function (e, t) {
                do if (e = e.parentNode, t(e) === !1)break; while ("HTML" !== e.nodeName)
            }, z = function () {
                var t, i, n, o, s, r, a, l, u, d, c, h, f;
                if (l = L.data("input"), t = l.offset(), i = l[0], d = "top", n = t.top + i.offsetHeight - 1, o = t.left, s = "absolute", u = e(window).width(), h = e(window).height(), f = e(window).scrollTop(), document.documentElement.clientWidth - t.left < N.parent().outerWidth(!0)) {
                    var p = N.parent().outerWidth(!0) - i.offsetWidth;
                    o -= p
                }
                "rtl" === l.parent().css("direction") && (o -= L.outerWidth() - l.outerWidth()), F.fixed ? (n -= f, o -= e(window).scrollLeft(), s = "fixed") : (a = !1, W(i, function (e) {
                    return "fixed" === window.getComputedStyle(e).getPropertyValue("position") ? (a = !0, !1) : void 0
                }), a ? (s = "fixed", n + L.outerHeight() > h + f ? (d = "bottom", n = h + f - t.top) : n -= f) : n + i.offsetHeight > h + f && (n = t.top - i.offsetHeight + 1), 0 > n && (n = 0), o + i.offsetWidth > u && (o = u - i.offsetWidth)), r = L[0], W(r, function (e) {
                    var t;
                    return t = window.getComputedStyle(e).getPropertyValue("position"), "relative" === t && u >= e.offsetWidth ? (o -= (u - e.offsetWidth) / 2, !1) : void 0
                }), c = {position: s, left: o, top: "", bottom: ""}, c[d] = n, L.css(c)
            }, L.on("open.xdsoft", function (t) {
                var i = !0;
                F.onShow && e.isFunction(F.onShow) && (i = F.onShow.call(L, j.currentTime, L.data("input"), t)), i !== !1 && (L.show(), z(), e(window).off("resize.xdsoft", z).on("resize.xdsoft", z), F.closeOnWithoutClick && e([document.body, window]).on("touchstart mousedown.xdsoft", function n() {
                    L.trigger("close.xdsoft"), e([document.body, window]).off("touchstart mousedown.xdsoft", n)
                }))
            }).on("close.xdsoft", function (t) {
                var i = !0;
                H.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), F.onClose && e.isFunction(F.onClose) && (i = F.onClose.call(L, j.currentTime, L.data("input"), t)), i === !1 || F.opened || F.inline || L.hide(), t.stopPropagation()
            }).on("toggle.xdsoft", function () {
                L.trigger(L.is(":visible") ? "close.xdsoft" : "open.xdsoft")
            }).data("input", n), G = 0, L.data("xdsoft_datetime", j), L.setOptions(F), j.setCurrentTime(a()), n.data("xdsoft_datetimepicker", L).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function () {
                n.is(":disabled") || n.data("xdsoft_datetimepicker").is(":visible") && F.closeOnInputClick || (clearTimeout(G), G = setTimeout(function () {
                    n.is(":disabled") || (X = !0, j.setCurrentTime(a(), !0), F.mask && l(F), L.trigger("open.xdsoft"))
                }, 100))
            }).on("keydown.xdsoft", function (t) {
                var i, n = t.which;
                return -1 !== [v].indexOf(n) && F.enterLikeTab ? (i = e("input:visible,textarea:visible,button:visible,a:visible"), L.trigger("close.xdsoft"), i.eq(i.index(this) + 1).focus(), !1) : -1 !== [T].indexOf(n) ? (L.trigger("close.xdsoft"), !0) : void 0
            }).on("blur.xdsoft", function () {
                L.trigger("close.xdsoft")
            })
        }, u = function (t) {
            var i = t.data("xdsoft_datetimepicker");
            i && (i.data("xdsoft_datetime", null), i.remove(), t.data("xdsoft_datetimepicker", null).off(".xdsoft"), e(window).off("resize.xdsoft"), e([window, document.body]).off("mousedown.xdsoft touchstart"), t.unmousewheel && t.unmousewheel())
            ...
            if (i) {
                if ("string" === e.type(s))switch (s) {
                    ...
                    case"destroy":
                        ...
                        break;
                    case"reset":
                        this.value = this.defaultValue, this.value && i.data("xdsoft_datetime").isValidDate(o.parseDate(this.value, F.format)) || i.data("changed", !1), i.data("xdsoft_datetime").setCurrentTime(this.value);
                        break;
                    case"validate":
                        t = i.data("input"), t.trigger("blur.xdsoft");
                        break;
                    default:
                        i[s] && e.isFunction(i[s]) && (d = i[s](a))
                } else i.setOptions(s);
                return 0
            }
            "string" !== e.type(s) && (!F.lazyInit || F.open || F.inline ? l(e(this)) : P(e(this)))
        }), d
    ...
    function t(t) {
        var r = t || window.event, a = l.call(arguments, 1), u = 0, c = 0, h = 0, f = 0, p = 0, m = 0;
        if (t = e.event.fix(r), t.type = "mousewheel", "detail" in r && (h = -1 * r.detail), "wheelDelta" in r && (h = r.wheelDelta), "wheelDeltaY" in r && (h = r.wheelDeltaY), "wheelDeltaX" in r && (c = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (c = -1 * h, h = 0), u = 0 === h ? c : h, "deltaY" in r && (h = -1 * r.deltaY, u = h), "deltaX" in r && (c = r.deltaX, 0 === h && (u = -1 * c)), 0 !== h || 0 !== c) {
            if (1 === r.deltaMode) {
            ...
            if (f = Math.max(Math.abs(h), Math.abs(c)), (!s || s > f) && (s = f, n(r, f) && (s /= 40)), n(r, f) && (u /= 40, c /= 40, h /= 40), u = Math[u >= 1 ? "floor" : "ceil"](u / s), c = Math[c >= 1 ? "floor" : "ceil"](c / s), h = Math[h >= 1 ? "floor" : "ceil"](h / s), d.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                p = t.clientX - y.left, m = t.clientY - y.top
            }
            return t.deltaX = c, t.deltaY = h, t.deltaFactor = s, t.offsetX = p, t.offsetY = m, t.deltaMode = 0, a.unshift(t, u, c, h), o && clearTimeout(o), o = setTimeout(i, 200), (e.event.dispatch || e.event.handle).apply(this, a)
        }
    }
    ...
    if (e.event.fixHooks)for (var u = r.length; u;)e.event.fixHooks[r[--u]] = e.event.mouseHooks;
    ...
    e.mask = {
        ...
        caret: function (e, t) {
            ...
            return r = e.extend({
                ...
                completed: null
            }, r), l = e.mask.definitions, u = [], d = f = i.length, c = null, e.each(i.split(""), function (e, t) {
                "?" == t ? (f--, d = e) : l[t] ? (u.push(new RegExp(l[t])), null === c && (c = u.length - 1), d > e && (h = u.length - 1)) : u.push(null)
            }), this.trigger("unmask").each(function () {
                function a() {
                    if (r.completed) {
                        for (var e = c; h >= e; e++)if (u[e] && I[e] === m(e))return;
                        r.completed.call(E)
                    }
                }
                ...
                function y(e, t) {
                    var i, n;
                    if (!(0 > e)) {
                        for (i = e, n = g(t); f > i; i++)if (u[i]) {
                            if (!(f > n && u[i].test(I[n])))break;
                ...
                function b(e) {
                    var t, i, n, o;
                    for (t = e, i = m(e); f > t; t++)if (u[t]) {
                        if (n = g(t), o = I[t], I[t] = i, !(f > n && u[n].test(o)))break;
                        i = o
                    }
                }
                ...
                function w() {
                    ...
                    if (p && p.length && p.length > e.length) {
                        ...
                        if (0 === t.begin)for (; t.begin < c && !u[t.begin];)t.begin++;
                        E.caret(t.begin, t.begin)
                    } else {
                        for (D(!0); t.begin < f && !u[t.begin];)t.begin++;
                        E.caret(t.begin, t.begin)
                    }
                    a()
                }
                ...
                function S(e) {
                    if (!E.prop("readonly")) {
                        ...
                        p = E.val(), 8 === s || 46 === s || n && 127 === s ? (t = E.caret(), i = t.begin, o = t.end, o - i === 0 && (i = 46 !== s ? v(i) : o = g(i - 1), o = 46 === s ? g(o) : o), T(i, o), y(i, o - 1), e.preventDefault()) : 13 === s ? x.call(this, e) : 27 === s && (E.val(A), E.caret(0, D()), e.preventDefault())
                    }
                }

                function k(t) {
                    if (!E.prop("readonly")) {
                        var i, n, o, r = t.which || t.keyCode, l = E.caret();
                        if (!(t.ctrlKey || t.altKey || t.metaKey || 32 > r) && r && 13 !== r) {
                            if (l.end - l.begin !== 0 && (T(l.begin, l.end), y(l.begin, l.end - 1)), i = g(l.begin - 1), f > i && (n = String.fromCharCode(r), u[i].test(n))) {
                ...
                function D(e) {
                    var t, i, n, o = E.val(), s = -1;
                    for (t = 0, n = 0; f > t; t++)if (u[t]) {
                        for (I[t] = m(t); n++ < o.length;)if (i = o.charAt(n - 1), u[t].test(i)) {
                            I[t] = i, s = t;
                            break
                        }
                        if (n > o.length) {
                    ...
                    } else I[t] === o.charAt(n) && n++, d > t && (s = t);
                    return e ? C() : d > s + 1 ? r.autoclear || I.join("") === O ? (E.val() && E.val(""), T(0, f)) : C() : (C(), E.val(E.val().substring(0, s + 1))), d ? t : c
                }

                var E = e(this), I = e.map(i.split(""), function (e, t) {
                ...
                E.data(e.mask.dataName, function () {
                    ...
                    if (!E.prop("readonly")) {
                        clearTimeout(t);
                        var e;
                        A = E.val(), e = D(), t = setTimeout(function () {
                            E.get(0) === document.activeElement && (C(), e == i.replace("?", "").length ? E.caret(0, e) : E.caret(e))
                        }, 10)
                    }
                }).on("blur.mask", x).on("keydown.mask", S).on("keypress.mask", k).on("input.mask paste.mask", function () {
                    E.prop("readonly") || setTimeout(function () {
                        var e = D(!0);
                        E.caret(e), a()
                    }, 0)
                }), o && s && E.off("input.mask").on("input.mask", w), D()
            })
        }
    })
}), function (e) {
    ...
    e.extend(e.fn, {
        validate: function (t) {
            ...
            return i ? i : (this.attr("novalidate", "novalidate"), i = new e.validator(t, this[0]), e.data(this[0], "validator", i), i.settings.onsubmit && (this.on("click.validate", ":submit", function (t) {
                ...
                function n() {
                    var n, o;
                    return i.settings.submitHandler ? (i.submitButton && (n = e("<input type='hidden'/>").attr("name", i.submitButton.name).val(e(i.submitButton).val()).appendTo(i.currentForm)), o = i.settings.submitHandler.call(i, i.currentForm, t), i.submitButton && n.remove(), void 0 !== o ? o : !1) : !0
                }
            ...
            if (this.length) {
                var n, o, s, r, a, l, u = this[0];
                if (t)switch (n = e.data(u.form, "validator").settings, o = n.rules, s = e.validator.staticRules(u), t) {
                    case"add":
                        e.extend(s, e.validator.normalizeRule(i)), delete s.messages, o[u.name] = s, i.messages && (n.messages[u.name] = e.extend(n.messages[u.name], i.messages));
                        break;
                    case"remove":
                        return i ? (l = {}, e.each(i.split(/\s/), function (t, i) {
                            l[i] = s[i], delete s[i], "required" === i && e(u).removeAttr("aria-required")
                        }), l) : (delete o[u.name], s)
                }
        ...
        prototype: {
            init: function () {
                ...
                return void 0 === s ? delete this.invalid[o.name] : (this.prepareElement(s), this.currentElements = e(s), n = this.groups[s.name], n && e.each(this.groups, function (e, t) {
                    t === n && e !== s.name && (o = r.validationTargetFor(r.clean(r.findByName(e))), o && o.name in r.invalid && (r.currentElements.push(o), a = a && r.check(o)))
                }), i = this.check(s) !== !1, a = a && i, this.invalid[s.name] = i ? !1 : !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), e(t).attr("aria-invalid", !i)), a
                ...
                return "radio" === s || "checkbox" === s ? this.findByName(t.name).filter(":checked").val() : "number" === s && "undefined" != typeof t.validity ? t.validity.badInput ? "NaN" : o.val() : (i = t.hasAttribute("contenteditable") ? o.text() : o.val(), "file" === s ? "C:\\fakepath\\" === i.substr(0, 12) ? i.substr(12) : (n = i.lastIndexOf("/"), n >= 0 ? i.substr(n + 1) : (n = i.lastIndexOf("\\"), n >= 0 ? i.substr(n + 1) : i)) : "string" == typeof i ? i.replace(/\r/g, "") : i)
            }, check: function (t) {
                ...
                if ("function" == typeof s.normalizer) {
                    if (l = s.normalizer.call(t, l), "string" != typeof l)throw new TypeError("The normalizer should return a string value.");
                    delete s.normalizer
                }
                for (n in s) {
                ...
                var n, o, s, r, a = this.errorsFor(t), l = this.idOrName(t), u = e(t).attr("aria-describedby");
                a.length ? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(i)) : (a = e("<" + this.settings.errorElement + ">").attr("id", l + "-error").addClass(this.settings.errorClass).html(i || ""), n = a, this.settings.wrapper && (n = a.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(n) : this.settings.errorPlacement ? this.settings.errorPlacement(n, e(t)) : n.insertAfter(t), a.is("label") ? a.attr("for", l) : 0 === a.parents("label[for='" + this.escapeCssMeta(l) + "']").length && (s = a.attr("id"), u ? u.match(new RegExp("\\b" + this.escapeCssMeta(s) + "\\b")) || (u += " " + s) : u = s, e(t).attr("aria-describedby", u), o = this.groups[t.name], o && (r = this, e.each(r.groups, function (t, i) {
        ...
        normalizeRules: function (t, i) {
            return e.each(t, function (n, o) {
                ...
                if (o.param || o.depends) {
                    ...
                    s ? t[n] = void 0 !== o.param ? o.param : !0 : (e.data(i.form, "validator").resetElements(e(i)), delete t[n])
                }
        ...
        methods: {
            required: function (t, i, n) {
                ...
                var o = e(i).attr("type"), s = "Step attribute on input type " + o + " is not supported.", r = ["text", "number", "range"], a = new RegExp("\\b" + o + "\\b"), l = o && !a.test(r.join());
                ...
                return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), l.originalMessage = l.originalMessage || this.settings.messages[i.name][o], this.settings.messages[i.name][o] = l.message, n = "string" == typeof n && {url: n} || n, a = e.param(e.extend({data: t}, n.data)), l.old === a ? l.valid : (l.old = a, s = this, this.startRequest(i), r = {}, r[i.name] = t, e.ajax(e.extend(!0, {
                    ...
                    success: function (e) {
                        var n, r, a, u = e === !0 || "true" === e;
                        s.settings.messages[i.name][o] = l.originalMessage, u ? (a = s.formSubmitted, s.resetInternals(), s.toHide = s.errorsFor(i), s.formSubmitted = a, s.successList.push(i), s.invalid[i.name] = !1, s.showErrors()) : (n = {}, r = e || s.defaultMessage(i, {
                                method: o,
                                parameters: t
                            }), n[i.name] = l.message = r, s.invalid[i.name] = !0, s.showErrors(n)), l.valid = u, s.stopRequest(i, u)
                    }
                }, n)), "pending")
            }
        }
    ...
    function i(t) {
        return this.each(function () {
            var i = e(this), o = i.data("bs.collapse"), s = e.extend({}, n.DEFAULTS, i.data(), "object" == typeof t && t);
    ...
    e.fn.collapse = i, e.fn.collapse.Constructor = n, e.fn.collapse.noConflict = function () {
        ...
        var s = t(o), r = s.data("bs.collapse"), a = r ? "toggle" : o.data();
        i.call(s, a)
    })
}(jQuery), +function (e) {
    "use strict";
    ...
    e.fn.modal = t, e.fn.modal.Constructor = i, e.fn.modal.noConflict = function () {
        ...
        var n = e(this), o = n.attr("href"), s = e(n.attr("data-target") || o && o.replace(/.*(?=#[^\s]+$)/, "")), r = s.data("bs.modal") ? "toggle" : e.extend({remote: !/#/.test(o) && o}, s.data(), n.data());
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.prototype.show = function () {
        ...
        if (n || (n = t.attr("href"), n = n && n.replace(/.*(?=#[^\s]*$)/, "")), !t.parent("li").hasClass("active")) {
            var o = i.find(".active:last a"), s = e.Event("hide.bs.tab", {relatedTarget: t[0]}), r = e.Event("show.bs.tab", {relatedTarget: o[0]});
        ...
        var r = n.find("> .active"), a = o && e.support.transition && (r.length && r.hasClass("fade") || !!n.find("> .fade").length);
    ...
    function s(t) {
        if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
            ...
            for (var d = a.isBorderBox = "border-box" == s.boxSizing, c = 0; u > c; c++) {
                var h = l[c], f = s[h], p = parseFloat(f);
                a[h] = isNaN(p) ? 0 : p
            }
            var m = a.paddingLeft + a.paddingRight, g = a.paddingTop + a.paddingBottom, v = a.marginLeft + a.marginRight, y = a.marginTop + a.marginBottom, b = a.borderLeftWidth + a.borderRightWidth, w = a.borderTopWidth + a.borderBottomWidth, x = d && r, S = e(s.width);
    ...
    return i.htmlInit = function (t, o) {
        i.docReady(function () {
            var s = i.toDashed(o), r = "data-" + s, a = document.querySelectorAll("[" + r + "]"), l = document.querySelectorAll(".js-" + s), u = i.makeArray(a).concat(i.makeArray(l)), d = r + "-options", c = e.jQuery;
    ...
    var s = document.documentElement.style, r = "string" == typeof s.transition ? "transition" : "WebkitTransition", a = "string" == typeof s.transform ? "transform" : "WebkitTransform", l = {
        WebkitTransition: "webkitTransitionEnd",
        transition: "transitionend"
    }[r], u = {
        transform: a,
    ...
    d.constructor = n, d._create = function () {
        ...
        var e = getComputedStyle(this.element), t = this.layout._getOption("originLeft"), i = this.layout._getOption("originTop"), n = e[t ? "left" : "right"], o = e[i ? "top" : "bottom"], s = this.layout.size, r = -1 != n.indexOf("%") ? parseFloat(n) / 100 * s.width : parseInt(n, 10), a = -1 != o.indexOf("%") ? parseFloat(o) / 100 * s.height : parseInt(o, 10);
        ...
        var e = this.layout.size, t = {}, i = this.layout._getOption("originLeft"), n = this.layout._getOption("originTop"), o = i ? "paddingLeft" : "paddingRight", s = i ? "left" : "right", r = i ? "right" : "left", a = this.position.x + e[o];
        ...
        this.getPosition();
        var i = this.position.x, n = this.position.y, o = parseInt(e, 10), s = parseInt(t, 10), r = o === this.position.x && s === this.position.y;
    ...
    return i.compatOptions.fitWidth = "isFitWidth", i.prototype._resetLayout = function () {
        ...
        for (var o = this._getColGroup(n), s = Math.min.apply(Math, o), r = o.indexOf(s), a = {
            ...
            y: s
        }, l = s + e.size.outerHeight, u = this.cols + 1 - o.length, d = 0; u > d; d++)this.colYs[r + d] = l;
        return a
        ...
        var i = t(e), n = this._getElementOffset(e), o = this._getOption("originLeft"), s = o ? n.left : n.right, r = s + i.outerWidth, a = Math.floor(s / this.columnWidth);
        a = Math.max(0, a);
    ...
    return r.init = function (i) {
        i = i || {};
        var l = i.offset || 0, u = i.offsetVertical || l, c = i.offsetHorizontal || l, h = function (e, t) {
            return parseInt(e || t, 10)
        };
        t = {
            t: h(i.offsetTop, u),
            b: h(i.offsetBottom, u),
            l: h(i.offsetLeft, c),
            r: h(i.offsetRight, c)
        }, n = h(i.throttle, 250), o = i.debounce !== !1, s = !!i.unload, a = i.callback || a, r.render(), document.addEventListener ? (e.addEventListener("scroll", d, !1), e.addEventListener("load", d, !1)) : (e.attachEvent("onscroll", d), e.attachEvent("onload", d))
    }, r.render = function (i) {
        for (var n, o, l = (i || document).querySelectorAll("[data-echo], [data-echo-background]"), d = l.length, c = {
            l: 0 - t.l,
            t: 0 - t.t,
            b: (e.innerHeight || document.documentElement.clientHeight) + t.b,
            r: (e.innerWidth || document.documentElement.clientWidth) + t.r
        }, h = 0; d > h; h++)o = l[h], u(o, c) ? (s && o.setAttribute("data-echo-placeholder", o.src), null !== o.getAttribute("data-echo-background") ? o.style.backgroundImage = "url(" + o.getAttribute("data-echo-background") + ")" : o.src !== (n = o.getAttribute("data-echo")) && (o.src = n), s || (o.removeAttribute("data-echo"), o.removeAttribute("data-echo-background")), a(o, "load")) : s && (n = o.getAttribute("data-echo-placeholder")) && (null !== o.getAttribute("data-echo-background") ? o.style.backgroundImage = "url(" + n + ")" : o.src = n, o.removeAttribute("data-echo-placeholder"), a(o, "unload"));
        d || r.detach()
    }, r.detach = function () {
        document.removeEventListener ? e.removeEventListener("scroll", d) : e.detachEvent("onscroll", d), clearTimeout(i)
    }, r
}), $(document).ready(function () {
    var e = $("body"), t = e.find("#form-contact");
    t.validate({
        rules: {
            name: {required: !0, minlength: 3, maxlength: 32},
            email: {required: !0, email: !0},
            enquiry: {required: !0, minlength: 10, maxlength: 3e3}
        },
        messages: {
        ...
        submitHandler: function (t) {
            return $.ajax({
                ...
                dataType: "json",
                success: function (t) {
                    var i = e.find("#form-contact");
                    t.success && (i.find("input, textarea").val(""), e.find("#modalSuccess .modalSuccess-text").text("Ваше соощение успешно отправленно!"), e.find("#modalSuccess").modal("show")), t.error && console.log(t.error)
                }
            }), !1
        }
    });
    var i = e.find("#form-loginPopUp");
    i.validate({
        rules: {email: {required: !0}, password: {required: !0}},
        messages: {email: LANGS.login_form.error_email, password: LANGS.login_form.error_password},
        submitHandler: function (t) {
            return $.ajax({
                type: "POST",
                ...
                success: function (t) {
                    var i = e.find("#form-loginPopUp");
                    if (i.find(".alert").remove(), t.success && location.reload(), t.error) {
                        var n = '<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i>' + t.error.warning + "</div>";
                        i.prepend(n)
                    }
                }
            }), !1
    ...
    var n = e.find("#form-faq");
    n.validate({
        rules: {
            author_name: {required: !0, minlength: 3, maxlength: 32},
            author_mail: {required: !0, email: !0},
            title: {required: !0, minlength: 10, maxlength: 3e3}
        },
        messages: {
        ...
        submitHandler: function (t) {
            return $.ajax({
                ...
                dataType: "json",
                success: function (t) {
                    var i = e.find("#form-faq");
                    t.success && (i.find("input, textarea").val(""), e.find("#modalSuccess .modalSuccess-text").text("Ваш вопрос успешно отправленн!"), e.find("#modalSuccess").modal("show")), t.error && console.log(t.error)
                }
            }), !1
        }
    });
    var o = e.find("#form-review");
    o.validate({
        rules: {
            author_name: {required: !0, minlength: 3, maxlength: 32},
            author_mail: {required: !0, email: !0},
            author_review: {required: !0, minlength: 10, maxlength: 3e3}
        },
        messages: {
        ...
        submitHandler: function (t) {
            return $.ajax({
                ...
                dataType: "json",
                success: function (t) {
                    var i = e.find("#form-review");
                    t.success && (i.find("input, textarea").val(""), e.find("#modalSuccess .modalSuccess-text").text("Ваш отзыв успешно отправленн!"), e.find("#modalSuccess").modal("show")), t.error && console.log(t.error)
                }
            }), !1
        }
    });
    var s = e.find("#form-request");
    s.validate({
        rules: {name: {required: !0, minlength: 3, maxlength: 32}, tel: {required: !0}},
        messages: {name: LANGS.request_form.error_name, tel: LANGS.request_form.error_tel},
        submitHandler: function (t) {
            return $.ajax({
                type: "POST",
                ...
                dataType: "json",
                success: function (t) {
                    var i = e.find("#form-request");
                    t.success && (e.find("#modalRequest").modal("hide"), i.find("input, textarea").val(""), setTimeout(function () {
                        e.find("#modalSuccess").modal("show")
                    }, 300)), t.error && console.log(t.error)
                }
            }), !1
        }
    });
    var r = e.find("#form-question");
    r.validate({
        rules: {name: {required: !0, minlength: 3, maxlength: 32}, telephone: {required: !0}},
        messages: {name: LANGS.question_form.error_name, telephone: LANGS.question_form.error_tel},
        submitHandler: function (t) {
            return $.ajax({
                type: "POST",
                ...
                dataType: "json",
                success: function (t) {
                    var i = e.find("#form-question");
                    t.success && (i.find("input").val(""), setTimeout(function () {
                        e.find("#modalSuccess").modal("show")
                    }, 300)), t.error && console.log(t.error)
                }
            }), !1
    ...
    function e(e) {
        for (var t = document.getElementsByTagName("script"), i = new RegExp("^(.*/|)(" + e + ")([#?]|$)"), n = 0, o = t.length; o > n; n++) {
            var s = String(t[n].src).match(i);
            if (s)return s[1].match(/^((https?|file)\:\/{2,}|\w:[\/\\])/) ? s[1] : 0 == s[1].indexOf("/") ? s[1] : (b = document.getElementsByTagName("base"), b[0] && b[0].href ? b[0].href + s[1] : document.location.pathname.match(/(.*[\/\\])/)[0] + s[1])
        }
        return null
    }
    ...
    for (var i = document.getElementsByTagName("div"), n = 0; n < i.length; n++)if (-1 != i[n].className.indexOf("share42init")) {
        if (-1 != i[n].getAttribute("data-url"))var o = i[n].getAttribute("data-url");
        if (-1 != i[n].getAttribute("data-title"))var s = i[n].getAttribute("data-title");
        if (-1 != i[n].getAttribute("data-image"))var r = i[n].getAttribute("data-image");
        if (-1 != i[n].getAttribute("data-description"))var a = i[n].getAttribute("data-description");
        if (-1 != i[n].getAttribute("data-path"))var l = i[n].getAttribute("data-path");
        if (-1 != i[n].getAttribute("data-icons-file"))var u = i[n].getAttribute("data-icons-file");
        l || (l = e("share42.js")), o || (o = location.href), s || (s = document.title), u || (u = "icons.png"), a || (a = t()), o = encodeURIComponent(o), s = encodeURIComponent(s), s = s.replace(/\'/g, "%27"), r = encodeURIComponent(r), a = encodeURIComponent(a), a = a.replace(/\'/g, "%27");
        var d = "u=" + o;
        "null" != r && "" != r && (d = "s=100&p[url]=" + o + "&p[title]=" + s + "&p[summary]=" + a + "&p[images][0]=" + r);
        var c = "";
        "null" != r && "" != r && (c = "&image=" + r);
        var h = new Array('"#" data-count="vk" onclick="window.open(\'//vk.com/share.php?url=' + o + "&title=" + s + c + "&description=" + a + "', '_blank', 'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0');return false\" title=\"Поделиться В Контакте\"", '"#" data-count="fb" onclick="window.open(\'//www.facebook.com/sharer/sharer.php?u=' + o + "', '_blank', 'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0');return false\" title=\"Поделиться в Facebook\"", '"#" data-count="odkl" onclick="window.open(\'//ok.ru/dk?st.cmd=addShare&st._surl=' + o + "&title=" + s + "', '_blank', 'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0');return false\" title=\"Добавить в Одноклассники\""), f = "";
        for (j = 0; j < h.length; j++)f += '<a rel="nofollow" style="display:inline-block;vertical-align:top;width:38px;height:38px;margin:0 10px 0 0;padding:0;outline:none;background:url(' + l + u + ") -" + 38 * j + 'px 0 no-repeat" href=' + h[j] + ' target="_blank"></a>';
        i[n].innerHTML = '<span id="share42">' + f + "</span>"
    }
}, !1), function (e, t) {
    "function" == typeof define && define.amd ? define(function () {
        return e.is = t()
    ...
    function t(e) {
        return function () {
            for (var t = o(arguments), i = t.length, n = 0; i > n; n++)if (!e.call(null, t[n]))return !1;
            return !0
        }
    }
    ...
    function i(e) {
        return function () {
            for (var t = o(arguments), i = t.length, n = 0; i > n; n++)if (e.call(null, t[n]))return !0;
            return !1
        }
    }

    function n(e, t) {
        var i = t + "", n = +(i.match(/\d+/) || 0 / 0), o = i.match(/^[<>]=?|/)[0];
        return c[o] ? c[o](e, n) : e == n || n !== n
    }

    function o(e) {
        var t = u.call(e), i = t.length;
        return 1 === i && a.array(t[0]) && (t = t[0]), t
    }
    ...
    function r() {
        var n = a;
        for (var o in n)if (d.call(n, o) && a["function"](n[o]))for (var s = n[o].api || ["not", "all", "any"], r = 0; r < s.length; r++)"not" === s[r] && (a.not[o] = e(a[o])), "all" === s[r] && (a.all[o] = t(a[o])), "any" === s[r] && (a.any[o] = i(a[o]))
    }

    var a = {};
    a.VERSION = "0.9.0", a.not = {}, a.all = {}, a.any = {};
    var l = Object.prototype.toString, u = Array.prototype.slice, d = Object.prototype.hasOwnProperty, c = {
        "<": function (e, t) {
            return t > e
        }, "<=": function (e, t) {
            return t >= e
    ...
    a.arguments = function (e) {
        return "[object Arguments]" === l.call(e) || null != e && "object" == typeof e && "callee" in e
        ...
        return "[object Error]" === l.call(e)
    }, a["function"] = function (e) {
        return "[object Function]" === l.call(e) || "function" == typeof e
    }, a.json = function (e) {
        ...
        return a.not.nan(e) && "[object Number]" === l.call(e)
    }, a.object = function (e) {
        return Object(e) === e
    }, a.regexp = function (e) {
        ...
        var i = l.call(e);
        return i !== l.call(t) ? !1 : "[object Number]" === i ? !a.any.nan(e, t) || a.all.nan(e, t) : !0
        ...
        if (a.object(e)) {
            ...
            return 0 === t || 1 === t && a.array(e) || 2 === t && a.arguments(e) ? !0 : !1
        }
        return "" === e
    }, a.existy = function (e) {
        return null != e
        ...
        return a.all.number(e, t) ? e === t && 1 / e === 1 / t : a.all.string(e, t) || a.all.regexp(e, t) ? "" + e == "" + t : a.all.boolean(e, t) ? e === t : !1
        ...
        return a.number(e) && 0 > e
    }, a.odd = function (e) {
        return a.number(e) && e % 2 === 1
    }, a.positive = function (e) {
        return a.number(e) && e > 0
    }, a.under = function (e, t) {
        return a.all.number(e, t) && t > e
    }, a.under.api = ["not"], a.within = function (e, t, i) {
        return a.all.number(e, t, i) && e > t && i > e
    }, a.within.api = ["not"];
    var h = {
    ...
    for (var f in h)h.hasOwnProperty(f) && s(f, h);
    a.ip = function (e) {
        ...
        for (var t = e.length - 1, i = 0, n = Math.floor(t / 2); n >= i; i++)if (e.charAt(i) !== e.charAt(t - i))return !1;
        return !0
    }, a.space = function (e) {
    ...
    var p = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"], m = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];
    a.day = function (e, t) {
        return a.date(e) && t.toLowerCase() === p[e.getDay()]
    }, a.day.api = ["not"], a.dayLightSavingTime = function (e) {
        var t = new Date(e.getFullYear(), 0, 1), i = new Date(e.getFullYear(), 6, 1), n = Math.max(t.getTimezoneOffset(), i.getTimezoneOffset());
        return e.getTimezoneOffset() < n
    }, a.future = function (e) {
        var t = new Date;
        return a.date(e) && e.getTime() > t.getTime()
    }, a.inDateRange = function (e, t, i) {
        if (a.not.date(e) || a.not.date(t) || a.not.date(i))return !1;
        var n = e.getTime();
        return n > t.getTime() && n < i.getTime()
        ...
        return a.date(e) && t.toLowerCase() === m[e.getMonth()]
        ...
        var t = new Date, i = t.toDateString();
        return a.date(e) && e.toDateString() === i
    }, a.tomorrow = function (e) {
        var t = new Date, i = new Date(t.setDate(t.getDate() + 1)).toDateString();
        return a.date(e) && e.toDateString() === i
    ...
    var g = a.windowObject("object" == typeof global && global) && global, v = a.windowObject("object" == typeof self && self) && self, y = a.windowObject("object" == typeof this && this) && this, b = g || v || y || Function("return this")(), w = v && v.document, x = b.is, S = v && v.navigator, k = (S && S.appVersion || "").toLowerCase(), T = (S && S.userAgent || "").toLowerCase(), C = (S && S.vendor || "").toLowerCase();
    return a.android = function () {
        ...
        var t = T.match(/(?:^opera.+?version|opr)\/(\d+)/);
        return null !== t && n(t[1], e)
    }, a.opera.api = ["not"], a.phantom = function (e) {
        var t = T.match(/phantomjs\/(\d+)/);
        return null !== t && n(t[1], e)
    }, a.phantom.api = ["not"], a.safari = function (e) {
        var t = T.match(/version\/(\d+).+?safari/);
        return null !== t && n(t[1], e)
        ...
        for (var i = c[t] || c[">="], n = 1; n < e.length; n++)if (!i(e[n], e[n - 1]))return !1;
        return !0
    }, r(), a.setNamespace = function () {
        return b.is = x, this
    }, a.setRegexp = function (e, t) {
        for (var i in h)d.call(h, i) && t === i && (h[i] = e)
    }, a
});